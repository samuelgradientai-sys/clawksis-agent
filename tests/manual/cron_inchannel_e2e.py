...
Uses a throwaway CLAWK_HOME so it never touches ~/.clawksis. No real names.
"""
...
def _fresh_home():
    """Point CLAWK_HOME at a throwaway dir BEFORE importing gateway modules
    (mirror.py binds _SESSIONS_INDEX from get_clawk_home() at import time)."""
...
# Import AFTER CLAWK_HOME is set.
...
# a different get_clawk_home() at import if something imported it earlier).
