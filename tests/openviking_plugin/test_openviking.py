...
class TestOpenVikingSkillQuerySafety:
    ...
    def test_skill_markers_match_clawk_scaffolding(self, tmp_path, monkeypatch):
            ...
            turn = [
                ...
                },
                {
                    ...
                    "content": json.dumps({
                        "results": [
                            {
                                "uri": "viking://user/clawk/memories/context",
...
class TestOpenVikingRead:
    ...
    def test_read_accepts_uri_batch_and_caps_batch_full_content(self):
        provider = OpenVikingMemoryProvider()
        uris = [
            "viking://user/clawk/memories/a.md",
            "viking://user/clawk/memories/b.md",
...
class TestOpenVikingAutoRecallPrefetch:
    def test_prefetch_e2e_sends_limit_and_reads_l2_content(self, monkeypatch):
                    ...
                    if payload.get("context_type") == "memory":
                        self._send_json({
                            "result": {
                                "memories": [
                                    {
                                        "uri": "viking://user/peers/clawk/memories/e2e-full.md",
                                        "score": 0.9,
                                        "level": 2,
                                        "category": "events",
        ...
        monkeypatch.setenv("OPENVIKING_AGENT", "clawk")
        ...
        assert records["reads"] == ["viking://user/peers/clawk/memories/e2e-full.md"]
        ...
        responses = {
            (
                ...
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/clawk/memories/caroline.md",
                            "score": 0.9,
                            "level": 1,
                            "category": "profile",
        ...
        responses = {
            ...
            (
                ...
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/clawk/memories/melanie-race.md",
                            "score": 0.9,
                            "level": 1,
                            "category": "events",
        ...
        responses = {
            ("/api/v1/search/search", "memory", "What should we recall?", "session-test"): {
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/clawk/memories/keep.md",
                            "score": 0.22,
                            "level": 1,
                        ...
                        {
                            "uri": "viking://user/peers/clawk/memories/drop.md",
                            "score": 0.12,
                            "level": 1,
                            "category": "preferences",
        ...
        responses = {
            ("/api/v1/search/search", "memory", "What should we recall?", "session-test"): {
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/clawk/memories/too-large.md",
                            "score": 0.9,
                            "level": 1,
                            "category": "memory",
                        ...
                        {
                            "uri": "viking://user/peers/clawk/memories/small.md",
                            "score": 0.8,
                            "level": 1,
                            "category": "memory",
        ...
        responses = {
            ("/api/v1/search/search", "memory", "What should we recall?", "session-test"): {
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/clawk/memories/full.md",
                            "score": 0.9,
                            "level": 2,
                            "category": "events",
            ...
            ("/api/v1/content/read", "viking://user/peers/clawk/memories/full.md"): {
