...
thinking phase.  Clawksis's default cloud-stream stale detector
(``CLAWK_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``CLAWK_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            600.0,
        ),  # catalog -free variant inherits via separator anchor
