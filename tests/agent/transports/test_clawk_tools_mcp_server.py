"""Tests for the clawk-tools-as-MCP server module surface.
...
from agent.transports.clawk_tools_mcp_server import (
...
class TestModuleSurface:
    ...
    def test_expected_clawk_specific_tools_listed(self):
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `clawk chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.clawk_tools_mcp_server as m
