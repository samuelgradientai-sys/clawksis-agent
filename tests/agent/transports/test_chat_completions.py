...
class TestChatCompletionsBasic:
    ...
    def test_convert_messages_strips_internal_scaffolding_markers(self, transport):
        """Clawksis-internal ``_``-prefixed markers must never reach the wire.
    ...
    def test_same_history_survives_strict_then_gemini_model_switch(self, transport):
        ...
        strict = transport.convert_messages(
            msgs, model="accounts/fireworks/models/llama"
        )
...
class TestChatCompletionsBuildKwargs:
    ...
    def test_gemma_does_not_receive_thinking_config(self, transport):
        ...
        # when Clawksis has reasoning enabled, the field must be omitted for
