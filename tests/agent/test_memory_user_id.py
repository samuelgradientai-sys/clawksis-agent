...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_clawk_user(self):
        """Without user_id or config override, should default to 'clawk-user'."""
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"CLAWK_HOME": "/tmp/test_clawk"}):
