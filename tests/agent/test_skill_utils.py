...
def test_metadata_as_dict_with_clawk():
    """Normal case: metadata is a dict containing clawk keys."""
    frontmatter = {
        "metadata": {
            "clawk": {
...
class TestParseFrontmatterBOM:
    ...
    def test_bom_config_vars_preserved(self):
        # metadata.clawk.config drives secure setup-on-load; it must survive
