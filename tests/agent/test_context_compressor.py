...
class TestAuthFailureAborts:
    ...
    def test_missing_provider_api_key_preserves_original_messages(self):
        ...
        err = RuntimeError(
            ...
            "to a different provider with clawk model."
        )
        with patch(
            "agent.context_compressor.get_model_context_length", return_value=100000
        ):
...
class TestTruncateToolCallArgsJson:
    ...
    def test_shrunken_args_remain_valid_json(self):
        ...
        original = _json.dumps({
            "path": "~/.clawksis/skills/shopping/browser-setup-notes.md",
        ...
        assert parsed["path"] == "~/.clawksis/skills/shopping/browser-setup-notes.md"
