...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure CLAWK_REDACT_SECRETS is not disabled by prior test imports."""
...
class TestApiKeyHeaders:
    ...
    def test_x_goog_api_key_header_masked(self):
        # Fork regression: Google's REST header name must be masked by the
        # header rule, not only by the AIza known-prefix rule.
