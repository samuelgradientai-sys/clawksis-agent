...
_CA_ENV_VARS = ("CLAWK_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE")
...
def test_clawk_ca_bundle_returns_ssl_context(clean_ca_env, monkeypatch):
...
def test_missing_ca_bundle_falls_back_to_true(clean_ca_env, monkeypatch):
    monkeypatch.setenv("CLAWK_CA_BUNDLE", "/nonexistent/root-ca.pem")
