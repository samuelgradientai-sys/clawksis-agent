...
""",
        ...
        from clawk_cli import config as _config_mod
    ...
    def test_missing_plugin_entry_yields_default_deny(self, tmp_path, monkeypatch):
        ...
        (clawk_home / "config.yaml").write_text("plugins: {}\n", encoding="utf-8")
...
class TestPluginContextIntegration:
    ...
    def test_ctx_llm_is_lazy_singleton(self):
        ...
        from clawk_cli.plugins import PluginContext, PluginManifest, PluginManager
