...
class TestBlueBubblesHelpers:
    ...
    def test_default_mention_patterns_match_clawk_variants(self, monkeypatch):
        ...
        assert adapter._message_matches_mention_patterns("@Clawksis help")
    ...
    def test_custom_mention_patterns_override_defaults(self, monkeypatch):
        ...
        assert not adapter._message_matches_mention_patterns("Clawksis what is next?")
