...
class TestPlatformsMerge:
    ...
    def test_get_all_platforms_includes_builtins(self):
        ...
        from clawk_cli.platforms import get_all_platforms, PLATFORMS
    ...
    def test_get_all_platforms_includes_plugin(self):
        ...
        from clawk_cli.platforms import get_all_platforms
    ...
    def test_platform_label_plugin_fallback(self):
        ...
        from clawk_cli.platforms import platform_label
...
class TestApplyYamlConfigFnDispatch:
    ...
    a tmp CLAWK_HOME, calls load_gateway_config(), and asserts the hook
    ...
    def _write_config(self, tmp_path, content: str):
        ...
        (clawk_home / "config.yaml").write_text(content, encoding="utf-8")
