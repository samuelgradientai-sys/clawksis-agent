...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("CLAWK_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("CLAWK_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("CLAWK_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
