...
class TestUpdateCheckEndpoint:
    """``GET /api/clawksis/update/check`` reports availability without applying.
    ...
    ``POST /api/clawksis/update`` runs ``clawk update``.
    ...
    def test_git_install_reports_behind_count(self, monkeypatch):
        ...
        r = self.client.get("/api/clawksis/update/check")
    ...
    def test_up_to_date(self, monkeypatch):
        ...
        body = self.client.get("/api/clawksis/update/check").json()
