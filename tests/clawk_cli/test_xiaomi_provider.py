...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        ...
        from clawk_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in CLAWK_OVERLAYS

        overlay = CLAWK_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify clawk doctor recognizes Xiaomi env vars."""
