...
class TestCmdUpdateProfileSkillSync:
    ...
    def test_active_profile_included_in_skill_sync(
        ...
        default_p = SimpleNamespace(name="default", path=Path("/fake/.clawksis"))

        active_p = SimpleNamespace(name="bit", path=Path("/fake/.clawksis/profiles/bit"))

        other_p = SimpleNamespace(name="work", path=Path("/fake/.clawksis/profiles/work"))
