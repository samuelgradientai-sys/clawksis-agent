...
The main() function in clawk_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `clawk -c model`
...
def _build_parser():
    """Build a minimal replica of the clawk top-level parser."""
