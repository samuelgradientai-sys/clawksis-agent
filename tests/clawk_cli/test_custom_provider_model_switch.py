"""Tests that `clawk model` always shows the model selection menu for custom
...
class TestCustomProviderModelSwitch:
    ...
    def test_custom_endpoint_switch_prunes_stale_model_config_pool_entry(
        ...
        from clawk_cli.main import _model_flow_custom
...
class TestCustomProviderDiscoverModels:
    """#18726: honor ``discover_models: false`` in the terminal ``clawk model``
