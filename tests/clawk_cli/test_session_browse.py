"""Tests for the interactive session browser (`clawk sessions browse`).
...
from clawk_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """clawk sessions browse should be parseable."""
