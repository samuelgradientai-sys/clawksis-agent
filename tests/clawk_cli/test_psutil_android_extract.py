...
from clawk_cli.psutil_android import (
...
def test_install_psutil_android_compat_uses_patched_tree(tmp_path):
    ...
    with patch("urllib.request.urlretrieve", side_effect=fake_urlretrieve), \
         patch.object(clawk_main, "_run_install_with_heartbeat", side_effect=fake_run_install):

        clawk_main._install_psutil_android_compat(
    ...
    assert captured["env"] == {"CLAWK_TEST": "1"}
