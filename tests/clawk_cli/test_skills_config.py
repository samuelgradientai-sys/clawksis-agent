...
class TestGetDisabledSkillNames:
    ...
    def test_session_platform_env_var(self, tmp_path, monkeypatch):
        """CLAWK_SESSION_PLATFORM should be used when CLAWK_PLATFORM is unset."""
    ...
    def test_clawk_platform_takes_precedence(self, tmp_path, monkeypatch):
        """CLAWK_PLATFORM should win over CLAWK_SESSION_PLATFORM."""
