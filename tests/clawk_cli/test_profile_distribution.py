"""Tests for clawk_cli.profile_distribution — git-based profile installs.
...
# Isolated profile env (matches tests/clawk_cli/test_profiles.py)
...
class TestEnvTemplate:
    ...
    def test_empty_env_requires_is_header_only(self):
        ...
        assert "Clawksis distribution" in out
