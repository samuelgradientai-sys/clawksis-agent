"""Test the platform-branched PTY bridge import in clawk_cli.web_server.
...
def test_web_server_uses_win_pty_bridge_on_windows():
    ...
    from clawk_cli.win_pty_bridge import WinPtyBridge
    ...
    from clawk_cli.win_pty_bridge import PtyUnavailableError as WinErr
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from clawk_cli.pty_bridge import PtyBridge as PosixBridge
    from clawk_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    #       try:
    #           from clawk_cli.win_pty_bridge import WinPtyBridge as PtyBridge, ...
    #       except ImportError:
    #           PtyBridge = None
    #           ...
    #   else:
