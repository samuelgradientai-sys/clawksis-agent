...
from clawk_cli.nous_account import NousPortalAccountInfo, NousToolAccessInfo

from clawk_cli import nous_subscription as ns
...
def _capture_checklist(monkeypatch, *, selected_idx):
    ...
    monkeypatch.setattr("clawk_cli.config.save_config", lambda cfg: None, raising=False)
...
# ensure_nous_portal_access — inline login gate for `clawk tools`
