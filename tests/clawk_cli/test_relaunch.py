...
class TestResolveClawksisBin:
    ...
    def test_falls_back_to_path_which(self, monkeypatch):
        ...
        monkeypatch.setattr(
            relaunch_mod.shutil,
            "which",
            lambda name: "/usr/bin/clawk" if name == "clawk" else None,
        )
...
class TestRelaunch:
    ...
    def test_windows_uses_subprocess_not_execvp(self, monkeypatch):
        ...
        monkeypatch.setattr(
            relaunch_mod, "resolve_clawk_bin", lambda: r"C:\Users\test\clawk.exe"
        )
    ...
    def test_windows_surfaces_oserror_with_help(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            relaunch_mod, "resolve_clawk_bin", lambda: r"C:\missing.exe"
        )
...
class TestResolveClawksisBinWindowsPyGuard:
    ...
    def test_windows_py_argv0_with_no_clawk_on_path_returns_none(
        self, monkeypatch, tmp_path
    ):
