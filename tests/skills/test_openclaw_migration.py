...
def test_rebrand_text_replaces_openclaw_variants():
    ...
    assert (
        mod.rebrand_text("OpenClaw prefers Python 3.11")
        == "Clawksis prefers Python 3.11"
    )

    assert (
        mod.rebrand_text("I told Open Claw to use dark mode")
        == "I told Clawksis to use dark mode"
    )
    ...
    assert (
        ...
        == "clawk should always respond concisely"
    )
...
def test_rebrand_text_replaces_legacy_bot_names():
    ...
    assert (
        ...
        == "Clawksis remembers my timezone"
    )
    ...
    assert (
        ...
        == "Clawksis was configured for Spanish"
    )
...
def test_rebrand_text_handles_multiple_replacements():
    ...
    assert (
        ...
        == "Clawksis said to ask Clawksis about Clawksis settings"
    )
