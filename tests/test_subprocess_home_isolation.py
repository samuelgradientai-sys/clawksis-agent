...
See: https://github.com/samuelgradientai-sys/clawksis-agent/issues/4426
"""
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from clawk_cli.profiles import _PROFILE_DIRS
