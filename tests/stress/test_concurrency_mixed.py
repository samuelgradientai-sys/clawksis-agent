...
def worker_loop(worker_id: int, clawk_home: str, result_file: str) -> None:
...
def reclaimer_loop(clawk_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="clawk_mixed_stress_")
    print(f"CLAWK_HOME = {home}")
