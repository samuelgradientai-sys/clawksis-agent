"""Tests for ClawksisCLI initialization -- catches configuration bugs
...
class TestHistoryDisplay:
    ...
    def test_resume_updates_clawk_session_id_env_and_context(self, tmp_path):
        ...
        try:
            ...
            assert os.environ["CLAWK_SESSION_ID"] == "target_session"
...
class TestRootLevelProviderOverride:
    ...
    def test_model_provider_wins_over_root_provider(self, tmp_path, monkeypatch):
        ...
        import cli
        monkeypatch.setattr(cli, "_clawk_home", clawk_home)
    ...
    def test_normalize_model_name_save_roundtrip_migrates_key(self, tmp_path, monkeypatch):
        ...
        import clawk_cli.config as cfgmod
