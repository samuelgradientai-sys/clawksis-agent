...
def test_new_command_rotates_clawk_session_id_env_and_context(tmp_path):
    ...
    os.environ["CLAWK_SESSION_ID"] = old_session_id
    ...
    assert os.environ["CLAWK_SESSION_ID"] == cli.session_id

    assert get_session_env("CLAWK_SESSION_ID") == cli.session_id
