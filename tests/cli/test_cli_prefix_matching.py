"""Tests for slash command prefix matching in ClawksisCLI.process_command."""
...
class TestSlashCommandPrefixMatching:
    ...
    def test_exact_command_with_args_does_not_recurse(self):
        ...
        original_pc = ClawksisCLI.process_command
        ...
        with patch.object(ClawksisCLI, 'process_command', guarded), \
             patch.object(cli_obj, 'show_config'):
