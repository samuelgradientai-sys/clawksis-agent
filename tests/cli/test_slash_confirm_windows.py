...
def _make_cli():
    """Minimal ClawksisCLI shell exposing prompt/modal helpers."""
        ...
        def run_on_daemon():
            ...
            with (
                ...
                patch.object(
                    ...
                    side_effect=_call_soon_threadsafe,
                ),
                patch.object(cli, "_prompt_text_input") as mock_stdin,
                patch.object(
                    cli,
                    "_capture_modal_input_snapshot",
                    side_effect=lambda: setup_calls.append("capture"),
                ),
                patch.object(
                    cli,
                    "_restore_modal_input_snapshot",
                    side_effect=lambda: teardown_calls.append("restore"),
                ),
            ):
            ...
            try:
                with (
                    ...
                    submitter = threading.Thread(
                        target=_submit_after_delay, daemon=True
                    )
