"""Session <-> workspace grouping key (clawk_state.workspace_key).

The key is what `clawk sessions list --workspace` groups/filters on. It is a
...
from clawk_state import workspace_key
