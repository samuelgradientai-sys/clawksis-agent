...
def test_slash_worker_accepts_profile_home():
    ...
    with patch.dict(
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            assert call_kwargs["env"]["CLAWK_HOME"] == "/home/luke/.clawk/profiles/work"
...
def test_slash_worker_without_profile_home():
    ...
    with patch.dict(
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            call_kwargs = mock_popen.call_args[1]
            assert "env" in call_kwargs
            # CLAWK_HOME should be from parent env or undefined (inherited from os.environ)
...
def test_slash_worker_with_none_profile_home():
    ...
    with patch.dict(
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            call_kwargs = mock_popen.call_args[1]
            env = call_kwargs["env"]
            # When profile_home is None, CLAWK_HOME should come from parent env only
            if "CLAWK_HOME" in env:
