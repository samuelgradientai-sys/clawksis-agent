...
class TestGetDefaultModelForProvider:
    """Unit tests for clawk_cli.models.get_default_model_for_provider."""
    ...
    def test_catalog_label_overrides_constant(self):
        ...
        with patch(
            "clawk_cli.model_catalog.get_default_model_from_cache",
            ...
            assert (
                models_mod.get_default_model_for_provider("nous") == "qwen/qwen3.7-plus"
            )
