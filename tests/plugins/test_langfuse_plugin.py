...
# CLAWK_LANGFUSE_PUBLIC_KEY / SECRET_KEY at a template value like
...
# Clawksis logs.  The fix in `_get_langfuse()` validates the documented
...
class TestPlaceholderKeyDetection:
    ...
    def test_validate_langfuse_key_rejects_wrong_prefix(self, monkeypatch):
        ...
        assert "CLAWK_LANGFUSE_PUBLIC_KEY" in msg
    ...
    def test_placeholder_public_key_warns_and_skips(self, monkeypatch, caplog):
        ...
        monkeypatch.setenv("CLAWK_LANGFUSE_PUBLIC_KEY", "placeholder")

        monkeypatch.setenv("CLAWK_LANGFUSE_SECRET_KEY", "sk-lf-real-secret-xyz")
        ...
        assert "CLAWK_LANGFUSE_PUBLIC_KEY" in text
    ...
    def test_placeholder_secret_key_warns_and_skips(self, monkeypatch, caplog):
        ...
        monkeypatch.setenv("CLAWK_LANGFUSE_PUBLIC_KEY", "pk-lf-real-public-xyz")

        monkeypatch.setenv("CLAWK_LANGFUSE_SECRET_KEY", "test-key")
    ...
    def test_both_placeholders_one_warning_with_both_keys(self, monkeypatch, caplog):
        ...
        monkeypatch.setenv("CLAWK_LANGFUSE_SECRET_KEY", "placeholder")
    ...
    def test_legacy_LANGFUSE_PUBLIC_KEY_also_validated(self, monkeypatch, caplog):
        ...
        # CLAWK_-prefixed one — operators set the CLAWK_-prefixed one).
