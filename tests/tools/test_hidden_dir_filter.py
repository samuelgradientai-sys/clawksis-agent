...
class TestOldFilterBrokenOnWindows:
    ...
    def test_old_filter_misses_hub_on_windows_path(self):
        ...
        win_path = r"C:\Users\me\.clawk\skills\.hub\quarantine\evil-skill\SKILL.md"
    ...
    def test_old_filter_misses_git_on_windows_path(self):
        ...
        win_path = r"C:\Users\me\.clawk\skills\.git\config\SKILL.md"
    ...
    def test_old_filter_works_on_unix_path(self):
        ...
        unix_path = "/home/user/.clawksis/skills/.hub/quarantine/evil-skill/SKILL.md"
...
class TestNewFilterCrossPlatform:
    ...
    def test_hub_quarantine_filtered(self, tmp_path):
        ...
        p = tmp_path / ".clawksis" / "skills" / ".hub" / "quarantine" / "evil" / "SKILL.md"
    ...
    def test_git_dir_filtered(self, tmp_path):
        ...
        p = tmp_path / ".clawksis" / "skills" / ".git" / "hooks" / "SKILL.md"
    ...
    def test_github_dir_filtered(self, tmp_path):
        ...
        p = tmp_path / ".clawksis" / "skills" / ".github" / "workflows" / "SKILL.md"
    ...
    def test_normal_skill_not_filtered(self, tmp_path):
        ...
        p = tmp_path / ".clawksis" / "skills" / "my-cool-skill" / "SKILL.md"
    ...
    def test_nested_skill_not_filtered(self, tmp_path):
        ...
        p = tmp_path / ".clawksis" / "skills" / "org" / "deep-skill" / "SKILL.md"
    ...
    def test_dot_prefix_not_false_positive(self, tmp_path):
        ...
        p = tmp_path / ".clawksis" / "skills" / ".my-hidden-skill" / "SKILL.md"
