...
class TestExecuteCodeModeIntegration(unittest.TestCase):
    ...
    def test_strict_mode_runs_in_tmpdir(self):
        ...
        self.assertIn("clawk_sandbox_", result["output"])
    ...
    def test_project_mode_interpreter_is_venv_python(self):
        ...
        # The clawksis-agent venv is always active during tests, so this also
    ...
    def test_project_mode_can_still_import_clawk_tools(self):
        """Regression: clawk_tools still importable from non-tmpdir CWD.
    ...
    def test_strict_mode_can_still_import_clawk_tools(self):
