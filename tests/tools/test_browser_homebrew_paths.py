...
class TestRunBrowserCommandPathConstruction:
    ...
    def test_subprocess_preserves_executable_path_with_spaces(self, tmp_path):
        ...
        browser_path = "/Users/test/Library/Application Support/clawksis/node_modules/.bin/agent-browser"

        clawk_home = str(tmp_path / "clawk-home")
 ...
 patch("tools.browser_tool._chromium_installed", return_value=True), \
             ...
             patch("clawk_constants.Path.home", return_value=tmp_path), \
