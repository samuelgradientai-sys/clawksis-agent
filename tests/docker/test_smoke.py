...
Converted from the former ``.github/actions/clawk-smoke-test`` composite
...
def test_clawk_help(built_image: str) -> None:
    ...
    assert "Traceback" not in r.stderr, (
        f"clawk --help produced a traceback: {r.stderr[-2000:]!r}"
    )
