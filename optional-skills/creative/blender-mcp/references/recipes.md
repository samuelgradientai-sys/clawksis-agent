...
bpy.ops.mesh.primitive_uv_sphere_add(
    radius=1.5, location=(0, 0, 1.5), segments=64, ring_count=32
)
...
bpy.ops.mesh.primitive_torus_add(
    major_radius=1.0, minor_radius=0.4, major_segments=48, minor_segments=24
)
...
bpy.ops.mesh.primitive_torus_add(
    major_radius=1.02, minor_radius=0.42, major_segments=48, minor_segments=24
)
