#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Clawksis docs site.
...
Both publish at:
  https://clawksis-agent.nousresearch.com/docs/llms.txt
  https://clawksis-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://clawksis-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Clawksis as a Python Library", None),
        ("guides/use-mcp-with-clawk", "Use MCP with Clawksis", None),
        ("guides/use-voice-mode-with-clawk", "Use Voice Mode with Clawksis", None),
        ("guides/use-soul-with-clawk", "Use SOUL.md with Clawksis", None),
        ("guides/build-a-clawk-plugin", "Build a Clawksis Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Clawksis"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "clawksis-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/samuelgradientai-sys/clawksis-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Clawksis — Full Documentation\n",
        (
            "This file is the entire Clawksis documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Clawksis, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://clawksis-agent.nousresearch.com/docs\n",
        "Short index: https://clawksis-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
