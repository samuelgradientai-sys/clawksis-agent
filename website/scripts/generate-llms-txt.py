...
SITE_BASE = "https://github.com/samuelgradientai-sys/clawksis-agent"
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://github.com/samuelgradientai-sys/clawksis-agent",

        "Short index: https://github.com/samuelgradientai-sys/clawksis-agent",
