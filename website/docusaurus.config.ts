...
const config: Config = {
  ...
  url: 'https://samuelgradientai-sys.github.io',
  baseUrl: '/clawksis-agent/',

  organizationName: 'samuelgradientai-sys',
  projectName: 'clawksis-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/samuelgradientai-sys/clawksis-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/clawksis-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/samuelgradientai-sys/clawksis-agent/releases/latest',
          label: 'Download',
          position: 'left',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Discussions', href: 'https://github.com/samuelgradientai-sys/clawksis-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://github.com/samuelgradientai-sys/clawksis-agent/releases/latest' },
            { label: 'GitHub', href: 'https://github.com/samuelgradientai-sys/clawksis-agent' },
