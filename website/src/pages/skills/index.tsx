        ...
        {expanded && (
          ...
          <div className={styles.cardDetail}>
            ...
            <div className={styles.installHint}>
              ...
              <code>{skill.installCmd || `clawk skills install ${skill.name}`}</code>

              <CopyButton

                text={skill.installCmd || `clawk skills install ${skill.name}`}
...
export default function SkillsDashboard() {
  ...
  return (
    ...
    <Layout
      ...
      description="Browse all skills and plugins available for Clawksis"
      ...
      <div className={styles.page}>
        ...
        <header className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroEyebrow}>Clawksis</p>
