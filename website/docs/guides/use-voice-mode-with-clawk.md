---
sidebar_position: 8
title: "Use Voice Mode with Clawksis"
description: "A practical guide to setting up and using Clawksis voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Clawksis
...
- you want Clawksis sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Clawksis.
...
## Step 1: make sure normal Clawksis works first
...
Clawksis supports both local and cloud speech stacks.
...
4. Clawksis transcribes and responds
...
- asking Clawksis to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Clawksis loop.

## Tuning CLI behavior

### Silence threshold

If Clawksis starts/stops too aggressively, tune:
...
Clawksis stays a normal chat bot, but can speak replies.
...
- you want Clawksis to function like a portable research or ops assistant
...
Clawksis joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Clawksis detects speech boundaries
- transcripts are posted in the associated text channel
- Clawksis responds in text and audio
...
1. get text Clawksis working
2. install `clawksis-agent[voice]`
