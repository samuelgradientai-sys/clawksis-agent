...
[Download the Clawksis Desktop installer](https://clawksis-agent.nousresearch.com/desktop) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).
...
Prefer to review first? Download [`install.sh`](https://clawksis-agent.nousresearch.com/install.sh), inspect it, then run it.
