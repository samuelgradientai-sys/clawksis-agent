...
For how to ship skills in your own plugin, see [Build a Clawksis Plugin → Bundle skills](/developer-guide/plugins#bundle-skills).
...
clawk config get skills.config --json
```
