...
| Source | Optional — install with `clawk skills install official/web-development/page-agent` |
...
- User wants **Clawksis itself to drive a browser** → use Clawksis' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
