...
| Source | Optional — install with `clawk skills install official/research/qmd` |
...
Clawksis via the native MCP client. This is the preferred
...
Then configure Clawksis to connect via HTTP:
