...
| Source | Optional — install with `clawk skills install official/research/darwinian-evolver` |

| Path | `optional-skills/research/darwinian-evolver` |

| Version | `0.1.0` |

| Author | Bihruze (Asahi0x), Clawksis |
...
mkdir -p ~/.clawksis/cache/darwinian-evolver && cd ~/.clawksis/cache/darwinian-evolver
...
cd ~/.clawksis/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.clawksis/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.clawksis/skills/research/darwinian-evolver

DE_DIR=~/.clawksis/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Clawksis core.

   Custom driver scripts under `~/.clawksis/skills/...` are user-side and fine.
