...
| Source | Optional — install with `clawk skills install official/research/osint-investigation` |

| Path | `optional-skills/research/osint-investigation` |

| Version | `0.1.0` |

| Author | Clawksis (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $CLAWK_OSINT_CACHE/icij/ (default: ~/.cache/clawk-osint/icij/).
...
# Set CLAWK_OSINT_UA=your-app/1.0 (your@email) to identify yourself
