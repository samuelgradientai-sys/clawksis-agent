...
| Source | Optional — install with `clawk skills install official/software-development/subagent-driven-development` |

| Path | `optional-skills/software-development/subagent-driven-development` |

| Version | `1.1.0` |

| Author | Clawksis (adapted from obra/superpowers) |
