...
| Source | Optional — install with `clawk skills install official/software-development/code-wiki` |

| Path | `optional-skills/software-development/code-wiki` |

| Version | `0.1.0` |

| Author | Teknium (teknium1), Clawksis |
...
Invoke through the `terminal` tool from the target repo's root, then use `read_file` / `search_files` / `write_file` to produce the wiki. Default output location is `~/.clawksis/wikis/<repo-name>/`. Only write into the repo (`docs/wiki/`) when the user explicitly requests it.
...
OUTPUT_DIR="$HOME/.clawksis/wikis/$REPO_NAME"
...
- [`path/to/main.py`](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/<link>) — <what runs when you start it>

- [`path/to/cli.py`](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/<link>) — <CLI surface>
...
See [architecture.md](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/architecture.md).
...
| [`<module>`](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/modules/<module>.md) | <one-line purpose> |
...
See [getting-started.md](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/getting-started.md).
...
- **<Component>** — <1-2 sentences>. See [`modules/<module>.md`](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/modules/<module>.md).
...
1. **<Step>** — [`<file>`](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/<link>)

2. **<Step>** — [`<file>`](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
...
- [`<module>/<file>`](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/<link>) — <what it does>
...
1. **User input** — [`cli.py:ClawksisCLI.run_session`](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/<link>)

2. **Message dispatch** — [`run_agent.py:AIAgent.chat`](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
...
- Architecture: [architecture.md](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/architecture.md)

- Module reference: [README.md#module-map](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/optional-skills/software-development/code-wiki/README.md#module-map)
...

{
  ...
  "generator": "clawksis-agent code-wiki skill v0.1.0",
...
Generated wiki at ~/.clawksis/wikis/<repo-name>/:
...
- **In-repo output without asking.** Default is `~/.clawksis/wikis/`. Only write into the repo when the user explicitly requests it.
