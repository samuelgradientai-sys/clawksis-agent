...
| Source | Optional — install with `clawk skills install official/health/neuroskill-bci` |
...
Connect Clawksis to a running [NeuroSkill](https://neuroskill.com/) instance to read
