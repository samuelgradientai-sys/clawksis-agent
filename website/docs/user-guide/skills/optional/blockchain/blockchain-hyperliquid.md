...
| | |
|---|---|
| Source | Optional — install with `clawk skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Clawksis |
| License | MIT |
...
The script reads `${CLAWK_HOME:-~/.clawksis}/.env` for two optional defaults:
...
Helper script: `~/.clawksis/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.clawksis/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${CLAWK_HOME:-~/.clawksis}/.env`.
...
```bash
python3 ~/.clawksis/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.clawksis/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
