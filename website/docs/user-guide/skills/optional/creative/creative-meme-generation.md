...
| Source | Optional — install with `clawk skills install official/creative/meme-generation` |
...
4. Find the skill's script directory:
   ...
   SKILL_DIR=$(dirname "$(find ~/.clawksis/skills -path '*/meme-generation/SKILL.md' 2>/dev/null | head -1)")
