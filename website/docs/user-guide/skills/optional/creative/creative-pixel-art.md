...
| | |
|---|---|
| Source | Optional — install with `clawk skills install official/creative/pixel-art` |
...
```bash
cd /home/teknium/.clawksis/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Clawksis installs package this)
