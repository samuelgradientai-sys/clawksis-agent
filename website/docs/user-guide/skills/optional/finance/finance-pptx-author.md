...
| Source | Optional — install with `clawk skills install official/finance/pptx-author` |
...
| Related skills | [`excel-author`](/docs/user-guide/skills/optional/finance/finance-excel-author) |
