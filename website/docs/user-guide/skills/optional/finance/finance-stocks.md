...
| Source | Optional — install with `clawk skills install official/finance/stocks` |

| Path | `optional-skills/finance/stocks` |

| Version | `0.1.0` |

| Author | Mibay (Mibayy), Clawksis |
...
SCRIPT=~/.clawksis/skills/finance/stocks/scripts/stocks_client.py
...
python3 ~/.clawksis/skills/finance/stocks/scripts/stocks_client.py quote AAPL
