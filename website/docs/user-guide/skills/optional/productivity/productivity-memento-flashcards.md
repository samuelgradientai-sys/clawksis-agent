...
| Source | Optional — install with `clawk skills install official/productivity/memento-flashcards` |
...
~/.clawksis/skills/productivity/memento-flashcards/data/cards.json
...
python3 ~/.clawksis/skills/productivity/memento-flashcards/scripts/memento_cards.py add \
...
python3 ~/.clawksis/skills/productivity/memento-flashcards/scripts/memento_cards.py due
...
python3 ~/.clawksis/skills/productivity/memento-flashcards/scripts/memento_cards.py due --collection "History"
...
python3 ~/.clawksis/skills/productivity/memento-flashcards/scripts/memento_cards.py rate \
...
python3 ~/.clawksis/skills/productivity/memento-flashcards/scripts/youtube_quiz.py fetch VIDEO_ID
...
python3 ~/.clawksis/skills/productivity/memento-flashcards/scripts/memento_cards.py add-quiz \
...
python3 ~/.clawksis/skills/productivity/memento-flashcards/scripts/memento_cards.py export \
...
python3 ~/.clawksis/skills/productivity/memento-flashcards/scripts/memento_cards.py import \
...
python3 ~/.clawksis/skills/productivity/memento-flashcards/scripts/memento_cards.py stats
...
python3 ~/.clawksis/skills/productivity/memento-flashcards/scripts/memento_cards.py add --question "Capital of France?" --answer "Paris" --collection "General"
