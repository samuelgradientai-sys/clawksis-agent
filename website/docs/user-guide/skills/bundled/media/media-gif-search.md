...
Set your Tenor API key in your environment (add to `${CLAWK_HOME:-~/.clawksis}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/samuelgradientai-sys/clawksis-agent/blob/main/skills/media/gif-search/url)`
