...
| Author | Clawksis + Teknium (design systems sourced from VoltAgent/awesome-design-md) |
...
Each template includes a **Clawksis Implementation Notes** block at the top with:
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's Clawksis notes -->
