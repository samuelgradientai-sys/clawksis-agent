...
1. **Clawksis installed** — `pip install clawksis-agent` (see [Installation](/getting-started/installation))
...
pip install "clawksis-agent[voice]"

# Discord + Telegram messaging (includes discord.py[voice] for VC support)
pip install "clawksis-agent[messaging]"

# Premium TTS (ElevenLabs)
pip install "clawksis-agent[tts-premium]"

# Local TTS (NeuTTS, optional)
python -m pip install -U neutts[all]

# Everything at once
pip install "clawksis-agent[all]"
```
