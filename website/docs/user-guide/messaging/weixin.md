...
| Terminal QR code doesn't render | Reinstall with the messaging extra: `pip install clawksis-agent[messaging]`. Alternatively, open the URL printed above the QR |
