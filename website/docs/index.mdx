...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/NousResearch/clawksis-agent/releases/latest" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>Download Desktop</a>

  <a href="https://github.com/NousResearch/clawksis-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
...
curl -fsSL https://raw.githubusercontent.com/NousResearch/clawksis-agent/main/scripts/install.sh | bash
...
iex (irm https://raw.githubusercontent.com/NousResearch/clawksis-agent/main/scripts/install.ps1)
...
After installing, run `clawk setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Clawksis safely |

| 🧭 **[Use MCP with Clawksis](/guides/use-mcp-with-clawk)** | Practical MCP setup patterns, examples, and tutorials |

| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |

| 🗣️ **[Use Voice Mode with Clawksis](/guides/use-voice-mode-with-clawk)** | Hands-on setup and usage patterns for Clawksis voice workflows |

| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)** | Define Clawksis' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/guides/tips)** | Quick wins to get the most out of Clawksis |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Clawksis, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Clawksis, Nomos, and Psyche models
