 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `clawk_cli/web_server.py`.
 ...
 * Nous Blue — the inverted "light mode" Clawksis look, ported from the
 ...
 * nousnet-web's <body> is white; clawksis-agent's App root is `bg-black`,
