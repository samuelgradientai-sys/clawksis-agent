...
const STORAGE_KEY = "clawksis-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `clawk_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "clawk-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-clawk-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.setAttribute("data-clawk-theme-font", "true");
