 ...
 *
 * Plugins call window.__CLAWK_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__CLAWK_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__CLAWK_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__CLAWK_PLUGIN_SDK__ = {
    ...
    // window.__CLAWK_SESSION_TOKEN__ directly.
    authedFetch,
