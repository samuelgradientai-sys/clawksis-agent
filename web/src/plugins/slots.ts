 ...
 * `window.__CLAWK_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Clawksis brand in the top bar
 ...
 *  `window.__CLAWK_PLUGINS__.registerSlot(...)`.
 *
