...
export const fr: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Mettre à jour Clawksis",

    updatingClawksis: "Mise à jour de Clawksis…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Découvrez, installez, activez et mettez à jour les plugins Clawksis (parité avec `clawk plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.clawksis/plugins/ ?",

    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.clawksis/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.clawksis/skills/",
  ...
  config: {
    ...
    configPath: "~/.clawksis/config.yaml",
  ...
  achievements: {
    ...
    hero: {
      ...
      title: "Clawksis Achievements",

      subtitle:

        "Badges Clawksis à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",

      scan_subtitle:

        "Analyse de l'historique des sessions Clawksis en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    ...
    stats: {
      ...
      latest_hint_empty: "utilisez Clawksis davantage",
    ...
    guide: {
      ...
      secret_body:
        ...
        "Les secrets cachent leur déclencheur exact. Dès qu'Clawksis détecte un signal lié, la carte passe à Découvert et affiche son exigence.",

      scan_status_header: "État du scan",

      scan_status_body:

        "Clawksis analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Clawksis ☤",
