...
export const it: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Aggiorna Clawksis",

    updatingClawksis: "Aggiornamento di Clawksis…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Scopri, installa, abilita e aggiorna i plugin Clawksis (parità con `clawk plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.clawksis/plugins/?",

    removeHint: "Solo i plugin installati dall'utente in ~/.clawksis/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.clawksis/skills/",
  ...
  achievements: {
    ...
    hero: {
      ...
      subtitle:
        ...
        "Badge Clawksis da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",

      scan_subtitle:

        "Scansione della cronologia delle sessioni Clawksis in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    ...
    stats: {
      ...
      latest_hint_empty: "usa Clawksis di più",
    ...
    guide: {
      ...
      secret_body:
        ...
        "I segreti nascondono il loro trigger esatto. Quando Clawksis rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",

      scan_status_header: "Stato della scansione",

      scan_status_body:

        "Clawksis sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
