...
export const uk: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Оновити Clawksis",

    updatingClawksis: "Оновлення Clawksis…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Clawksis (паритет з `clawk plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.clawksis/plugins/?",

    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.clawksis/plugins.",
  ...
  skills: {
    ...
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.clawksis/skills/",
  ...
  achievements: {
    ...
    hero: {
      ...
      subtitle:
        ...
        "Колекційні значки Clawksis, отримані з реальної історії сеансів. Відомі, але ще не виконані досягнення показані як Виявлені; Секретні досягнення залишаються прихованими, доки не з'явиться перший відповідний сигнал.",

      scan_subtitle:

        "Сканування історії сеансів Clawksis. Перше сканування на великих історіях може тривати 5–10 секунд.",
    ...
    stats: {
      ...
      latest_hint_empty: "запускайте Clawksis частіше",
    ...
    guide: {
      ...
      secret_body:
        ...
        "Секрети приховують свій точний тригер. Щойно Clawksis побачить пов'язаний сигнал, картка стає Виявленою та показує свою умову.",

      scan_status_header: "Стан сканування",

      scan_status_body:

        "Clawksis одноразово сканує локальну історію, а потім картки з'являться автоматично. Якщо це триває кілька секунд — нічого не зависло.",
