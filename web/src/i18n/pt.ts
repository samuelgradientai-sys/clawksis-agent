...
export const pt: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Atualizar Clawksis",

    updatingClawksis: "A atualizar Clawksis…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Descobrir, instalar, ativar e atualizar plugins Clawksis (paridade com `clawk plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.clawksis/plugins/?",

    removeHint: "Apenas plugins instalados pelo utilizador em ~/.clawksis/plugins podem ser removidos.",
  ...
  skills: {
    ...
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.clawksis/skills/",
  ...
  achievements: {
    ...
    hero: {
      ...
      subtitle:
        ...
        "Distintivos colecionáveis do Clawksis obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",

      scan_subtitle:

        "A analisar o histórico de sessões do Clawksis. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    ...
    stats: {
      ...
      latest_hint_empty: "execute mais o Clawksis",
    ...
    guide: {
      ...
      secret_body:
        ...
        "As secretas escondem o seu acionador exato. Assim que o Clawksis detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",

      scan_status_header: "Estado da análise",

      scan_status_body:

        "O Clawksis analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
