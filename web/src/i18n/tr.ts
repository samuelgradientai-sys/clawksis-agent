...
export const tr: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Clawksis'i Güncelle",

    updatingClawksis: "Clawksis güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Clawksis eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`clawk plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.clawksis/plugins/ içinden kaldırılsın mı?",

    removeHint: "Yalnızca ~/.clawksis/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.clawksis/skills/ adresinden yüklenir",
  ...
  achievements: {
    ...
    hero: {
      ...
      subtitle:
        ...
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Clawksis rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",

      scan_subtitle:

        "Clawksis oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    ...
    stats: {
      ...
      latest_hint_empty: "Clawksis'i daha çok çalıştır",
    ...
    guide: {
      ...
      secret_body:
        ...
        "Sırlar, tetikleyicilerini saklı tutar. Clawksis ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",

      scan_status_header: "Tarama durumu",

      scan_status_body:

        "Clawksis yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
