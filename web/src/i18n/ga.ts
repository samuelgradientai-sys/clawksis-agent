...
export const ga: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Nuashonraigh Clawksis",

    updatingClawksis: "Ag nuashonrú Clawksis…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins Clawksis (paireacht le `clawk plugins`).",
    ...
    removeConfirm: "Bain an plugin seo ó ~/.clawksis/plugins/?",

    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.clawksis/plugins a bhaint.",
  ...
  skills: {
    ...
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.clawksis/skills/",
  ...
  achievements: {
    ...
    hero: {
      ...
      subtitle:
        ...
        "Suaitheantais Clawksis inbhailithe a thuilltear ó stair fíor-session. Léirítear gnóthachtálacha aitheanta neamhchríochnaithe mar Discovered; fanann gnóthachtálacha Secret i bhfolach go dtí go bhfeictear an chéad iompar comhoiriúnach.",

      scan_subtitle:

        "Stair session Clawksis á scanadh. Is féidir leis an gcéad scan 5–10 soicind a thógáil ar staireanna móra.",
    ...
    stats: {
      ...
      latest_hint_empty: "rith Clawksis níos mó",
    ...
    guide: {
      ...
      secret_body:
        ...
        "Coinníonn rúin a dtruicear cruinn faoi cheilt. Nuair a fheiceann Clawksis comhartha gaolmhar, athraíonn an cárta go Aimsithe agus taispeánann sé a riachtanas.",

      scan_status_header: "Stádas an scanta",

      scan_status_body:

        "Scanann Clawksis an stair logánta uair amháin, ansin feicfear cártaí go huathoibríoch. Níl aon rud sáinnithe má thógann sé cúpla soicind.",
