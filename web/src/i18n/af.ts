...
export const af: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Werk Clawksis op",

    updatingClawksis: "Besig om Clawksis op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Ontdek, installeer, aktiveer en werk Clawksis-inproppe op (`clawk plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.clawksis/plugins/?",

    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.clawksis/plugins kan verwyder word.",
  ...
  skills: {
    ...
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.clawksis/skills/",
  ...
  achievements: {
    ...
    hero: {
      ...
      subtitle:
        ...
        "Versamelbare Clawksis-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",

      scan_subtitle:

        "Clawksis-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    ...
    stats: {
      ...
      latest_hint_empty: "gebruik Clawksis meer",
    ...
    guide: {
      ...
      secret_body:
        ...
        "Geheime hou hul presiese sneller verborge. Sodra Clawksis 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",

      scan_status_header: "Skanderingstatus",

      scan_status_body:

        "Clawksis skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
