...
export const en: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Update Clawksis",

    updatingClawksis: "Updating Clawksis…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Discover, install, enable, and update Clawksis plugins (`clawk plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.clawksis/plugins/?",

    removeHint: "Only user-installed plugins under ~/.clawksis/plugins can be removed.",
  ...
  skills: {
    ...
    noSkills: "No skills found. Skills are loaded from ~/.clawksis/skills/",
  ...
  achievements: {
    ...
    hero: {
      ...
      subtitle:
        ...
        "Collectible Clawksis badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",

      scan_subtitle:

        "Scanning Clawksis session history. First scan can take 5–10 seconds on large histories.",
    ...
    stats: {
      ...
      latest_hint_empty: "run Clawksis more",
    ...
    guide: {
      ...
      secret_body:
        ...
        "Secrets hide their exact trigger. Once Clawksis sees a related signal, the card becomes Discovered and shows its requirement.",

      scan_status_header: "Scan status",

      scan_status_body:

        "Clawksis is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
