...
export const es: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Actualizar Clawksis",

    updatingClawksis: "Actualizando Clawksis…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Descubre, instala, habilita y actualiza complementos de Clawksis (equivalente a `clawk plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.clawksis/plugins/?",

    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.clawksis/plugins.",
  ...
  skills: {
    ...
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.clawksis/skills/",
  ...
  achievements: {
    ...
    hero: {
      ...
      subtitle:
        ...
        "Insignias coleccionables de Clawksis ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",

      scan_subtitle:

        "Escaneando el historial de sesiones de Clawksis. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    ...
    stats: {
      ...
      latest_hint_empty: "usa Clawksis más",
    ...
    guide: {
      ...
      secret_body:
        ...
        "Los secretos ocultan su disparador exacto. Una vez que Clawksis detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",

      scan_status_header: "Estado del escaneo",

      scan_status_body:

        "Clawksis está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
