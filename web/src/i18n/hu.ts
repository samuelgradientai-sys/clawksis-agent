...
export const hu: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Clawksis frissítése",

    updatingClawksis: "Clawksis frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Clawksis-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `clawk plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.clawksis/plugins/ mappából?",

    removeHint: "Csak a felhasználó által a ~/.clawksis/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    noSkills: "Nem található készség. A készségek a ~/.clawksis/skills/ mappából töltődnek be",
  ...
  achievements: {
    ...
    hero: {
      ...
      subtitle:
        ...
        "Gyűjthető Clawksis-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",

      scan_subtitle:

        "Clawksis munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    ...
    stats: {
      ...
      latest_hint_empty: "futtasd többet a Clawksist",
    ...
    guide: {
      ...
      secret_body:
        ...
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Clawksis kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",

      scan_status_header: "Vizsgálat állapota",

      scan_status_body:

        "A Clawksis egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
