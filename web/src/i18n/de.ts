...
export const de: Translations = {
  ...
  status: {
    ...
    updateClawksis: "Clawksis aktualisieren",

    updatingClawksis: "Clawksis wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      ...
      "Clawksis-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `clawk plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.clawksis/plugins/ entfernen?",

    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.clawksis/plugins können entfernt werden.",
  ...
  skills: {
    ...
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.clawksis/skills/ geladen",
  ...
  achievements: {
    ...
    hero: {
      ...
      subtitle:
        ...
        "Sammelbare Clawksis-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",

      scan_subtitle:

        "Clawksis-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    ...
    stats: {
      ...
      latest_hint_empty: "nutze Clawksis mehr",
    ...
    guide: {
      ...
      secret_body:
        ...
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Clawksis ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",

      scan_status_header: "Scan-Status",

      scan_status_body:

        "Clawksis scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
