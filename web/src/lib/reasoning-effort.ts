 ...
 *
 * Values mirror clawk_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Clawksis default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Clawksis' default when unset). */
