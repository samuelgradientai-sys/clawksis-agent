...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``clawk logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Clawksis preflight compression for codex app-server "
                "(mode=%s); Clawksis will not start thread compaction here.",
