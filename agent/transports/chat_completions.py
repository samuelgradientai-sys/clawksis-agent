...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Clawksis'
    ...
    # is stricter (low/high). Clamp Clawksis' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Clawksis-internal scaffolding markers — any top-level message key
