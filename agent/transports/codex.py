...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Clawksis's web-provider config and
        ...
        # native search engine for xAI sessions instead of Clawksis's
        # configured web provider (Tavily/etc.), and those results bypass
        # Clawksis's tool-trace / citation plumbing (they arrive baked into the
