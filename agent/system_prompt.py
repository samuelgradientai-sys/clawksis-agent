...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if active_profile == "default":
        stable_parts.append(
            ...
            "under ~/.clawksis/profiles/<name>/. Each profile has its own "
        ...
        stable_parts.append(
            ...
            f"and writes ~/.clawksis/profiles/{active_profile}/. The default "
            f"profile's data lives at ~/.clawksis/skills/, ~/.clawksis/plugins/, "
            f"~/.clawksis/cron/, ~/.clawksis/memories/ — those belong to a "
