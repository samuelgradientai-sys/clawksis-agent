...
def interruptible_api_call(agent, api_kwargs: dict):
    ...
    if _ttfb_timeout <= 0:
        ...
        _ttfb_disable_above = _env_float("CLAWK_CODEX_TTFB_DISABLE_ABOVE_TOKENS", 25_000.0)
        ...
        if (
            ...
            logger.info(
                ...
                "Set CLAWK_CODEX_TTFB_STRICT=1 to force early reconnects.",
...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    def _call_chat_completions():
        ...
        _base_timeout = (
            ...
            else float(os.getenv("CLAWK_API_TIMEOUT", 1800.0))
        )
        ...
        if _provider_timeout_cfg is not None:
            ...
            _stream_read_timeout = float(os.getenv("CLAWK_STREAM_READ_TIMEOUT", 120.0))
    ...
    def _call():
        ...
        _max_stream_retries = int(os.getenv("CLAWK_STREAM_RETRIES", 2))
    ...
    if _cfg_stale is not None:
        ...
        _stream_stale_timeout_base = float(os.getenv("CLAWK_STREAM_STALE_TIMEOUT", 180.0))
    # Local providers (Ollama, oMLX, llama-cpp) can take 300+ seconds
    # for prefill on large contexts.  Disable the stale detector unless
    # the user explicitly set CLAWK_STREAM_STALE_TIMEOUT.
