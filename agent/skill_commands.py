...
#
# When a user invokes a /skill (or /bundle), Clawksis expands the turn into a
...
# tests/openviking_plugin/test_openviking.py::test_skill_markers_match_clawk_scaffolding.
# ---------------------------------------------------------------------------
        ...
        for scan_dir in dirs_to_scan:
            for skill_md in iter_skill_index_files(scan_dir, "SKILL.md"):
                ...
                try:
                    ...
                    # with a core Clawksis slash command (name or alias). The
                    ...
                    if resolve_command(cmd_name) is not None:
                        logger.warning(
                            ...
                            "collides with a core Clawksis command; skipping "
...
def build_preloaded_skills_prompt(
    ...
    bundle-invocation gate (#59156). Without this, ``clawk -s <skill>`` or
    a deployment's ``CLAWK_TUI_SKILLS`` env var could force-load a skill an
