...
SWE Runner with Clawksis Trajectory Format



A runner that uses Clawksis's built-in execution environments

(local, docker, modal) and outputs trajectories in the Clawksis format
...
- Uses Clawksis's Docker, Modal, or Local environments for command execution

- Outputs trajectories in Clawksis format (from/value pairs with <tool_call>/<tool_response> XML)
...
# Terminal Tool Definition (matches Clawksis format)
...
def create_environment(
    ...
    **kwargs,
    ...
    Create an execution environment using Clawksis's built-in backends.
...
# Mini-SWE Runner with Clawksis Trajectory Format
...
class MiniSWERunner:
    ...
    Agent runner that uses Clawksis's built-in execution environments

    and outputs trajectories in Clawksis format.
    ...
    def _convert_to_clawk_format(
        self, messages: List[Dict[str, Any]], user_query: str, completed: bool
    ) -> List[Dict[str, Any]]:
        """

        Convert internal message format to Clawksis trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Clawksis trajectory format

        trajectory = self._convert_to_clawk_format(messages, task, completed)
...
def main(
    ...
    Run SWE tasks with Clawksis trajectory format output.
    ...
    print("🚀 Mini-SWE Runner with Clawksis Trajectory Format")
