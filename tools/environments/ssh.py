...
class SSHEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        self.control_dir = Path(tempfile.gettempdir()) / "clawk-ssh"
        ...
        self._sync_manager = FileSyncManager(
            get_files_fn=lambda: iter_sync_files(f"{self._remote_home}/.clawksis"),
    ...
    def _ensure_remote_dirs(self) -> None:
        """Create base ~/.clawksis directory tree on remote in one SSH call."""

        base = f"{self._remote_home}/.clawksis"
    ...
    def _ssh_bulk_download(self, dest: Path) -> None:
        ...
        # paths (e.g. home/user/.clawksis/skills/f.py), matching _pushed_hashes keys.

        rel_base = f"{self._remote_home}/.clawksis".lstrip("/")
