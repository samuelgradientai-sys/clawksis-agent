...
# via shell expansions like $HOME or $CLAWK_HOME.
...
DANGEROUS_PATTERNS = [
    ...
    (r'\bclawk\s+gateway\s+(stop|restart)\b', "stop/restart clawk gateway (kills running agents)"),
...
def check_dangerous_command(command: str, env_type: str,
    ...
    if not is_cli and not is_gateway:
        ...
        logger.warning(
            ...
            "(pattern: %s): %s — set CLAWK_INTERACTIVE or CLAWK_GATEWAY_SESSION to require approval.",
