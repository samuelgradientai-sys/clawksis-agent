...
# (clawk-* prefixed), and scenario toolsets.
#
...
def _load_config() -> dict:
    ...
    to the persistent config (clawk_cli/config.py load_config()) so that
        ...
        "properties": {
            ...
            "acp_command": {
                ...
                "description": (
                    ...
                    "Leave empty to use the parent's default transport (Clawksis subagents)."
                ),
            },
            "acp_args": {
                "type": "array",
