...
def auth_json_path():
    """Return the Clawksis auth store path, respecting CLAWK_HOME overrides."""
    return get_clawk_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`clawk tools`, banner/status paint, provider
