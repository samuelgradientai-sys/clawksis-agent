...
Trust levels:
  - builtin:   Ships with Clawksis. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.clawksis/\.env|\~/\.clawksis/\.env',
     "clawk_env_access", "critical", "exfiltration",
     "directly references Clawksis secrets file"),
    ...
    (r'\.clawksis/config\.yaml|\.clawksis/SOUL\.md',
     "clawk_config_mod", "critical", "persistence",
     "references Clawksis configuration files directly"),
...
# scan. `.skillignore` is the Clawksis-native name; `.clawhubignore` is honored
