...
# so they don't clutter the user's session history. Clawksis keeps "subagent"
# sessions VISIBLE (fork delta): delegated runs are part of the user's own
# work history here, not noise.
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Clawksis conversation history only. It is not evidence "
