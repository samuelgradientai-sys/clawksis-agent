#!/usr/bin/env python3
"""Read the in-app terminal pane in the Clawksis desktop GUI.
...
def check_read_terminal_requirements() -> bool:
    ...
    return (os.getenv("CLAWK_DESKTOP") or "").strip().lower() in ("1", "true", "yes")


READ_TERMINAL_SCHEMA = {
    "name": "read_terminal",
    "description": (
        "Read what's currently shown in the in-app terminal pane of the Clawksis "
