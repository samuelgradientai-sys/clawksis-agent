...
def _profile_user_agent() -> str:
    """Return a ``clawk-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from clawk_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"clawk-cli/{_ver}"
    except Exception:
        return "clawk-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # clawk-cli UA so the catalog endpoint is reachable.
