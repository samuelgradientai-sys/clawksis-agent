# Clawksis Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  ...
  - `~/.clawksis/plugins/clawk-achievements/state.json` (existing unlock state)

  - `~/.clawksis/plugins/clawk-achievements/scan_snapshot.json` (new)

  - `~/.clawksis/plugins/clawk-achievements/scan_checkpoint.json` (new)
