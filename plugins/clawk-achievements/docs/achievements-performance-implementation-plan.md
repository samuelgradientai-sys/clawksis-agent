# Clawksis Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.clawksis/plugins/clawk-achievements/scan_snapshot.json`.
...
- Checkpoint persisted at `~/.clawksis/plugins/clawk-achievements/scan_checkpoint.json`.
