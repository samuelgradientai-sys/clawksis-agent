...
ACHIEVEMENTS: List[Dict[str, Any]] = [
    # Agent Autonomy — mostly best-session feats
    {
        "id": "let_him_cook",
        "name": "Let Him Cook",
        "description": "Let Clawksis run a serious autonomous tool chain in one session.",
    ...
    },
    {
        ...
        "description": "Accumulate a lifetime avalanche of Clawksis tool calls across sessions.",
        "category": "Agent Autonomy",
        "kind": "lifetime",
        "icon": "avalanche",
    ...
    },
    {
        ...
        "description": "Use a wide spread of distinct Clawksis tools in one session.",
        "category": "Agent Autonomy",
        "kind": "best_session",
        "icon": "nodes",
    ...
    # Clawksis Native
    {
        "id": "skillsmith",
        "name": "Skillsmith",
        "description": "Work with Clawksis skills enough to leave fingerprints.",
        "category": "Clawksis Native",
        "kind": "lifetime",
        "icon": "hammer_scroll",
    ...
    },
    {
        ...
        "description": "Live through gateway-connected Clawksis workflows.",
        "category": "Clawksis Native",
        "kind": "lifetime",
        "icon": "antenna",
    ...
    },
    {
        ...
        "description": "Use a real spread of distinct model names across Clawksis history.",
        "category": "Model Lore",
        "kind": "lifetime",
        "icon": "prism",
    ...
    },
    {
        ...
        "description": "Use models from multiple providers across Clawksis history.",
        "category": "Model Lore",
        "kind": "lifetime",
        "icon": "swap",
    ...
    },
    {
        ...
        "description": "Actually chat with local/open-weight models through Clawksis session metadata.",
        "category": "Model Lore",
        "kind": "lifetime",
        "icon": "terminal",
    ...
    # Workflow Intelligence
    {
        ...
        "description": "Navigate Clawksis toolsets deliberately instead of treating tools as a blur.",
        "category": "Clawksis Native",
        "kind": "lifetime",
        "icon": "compass",
    ...
    # Lifestyle
    {
        ...
        "description": "Accumulate a serious number of Clawksis sessions.",
        "category": "Lifestyle",
        "kind": "lifetime",
        "icon": "marathon",
    ...
    },
    {
        ...
        "description": "Run Clawksis on weekends enough times to make it a lifestyle.",
        "category": "Lifestyle",
        "kind": "lifetime",
        "icon": "calendar",
...
def analyze_messages(
    ...
    return {
        ...
        "plugin_events": len(
            re.findall(
                r"plugin|dashboard-plugins|__CLAWK_PLUGIN|manifest\.json",
                full_text,
                re.I,
            )
        ),
...
def display_achievement(item: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if clean.get("state") == "secret":
        return {
            **clean,
            "name": "???",
            "description": "Secret achievement: hidden until Clawksis detects the first relevant behavior in your session history.",
