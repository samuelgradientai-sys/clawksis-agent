(function () {
  ...
  // clawk-achievements dashboard plugin

  // Originally authored by @PCinkusz — https://github.com/PCinkusz/clawk-achievements (MIT).

  // Bundled into clawksis-agent. Upstream repo remains the staging ground for new
  ...
  if (!SDK || !window.__CLAWK_PLUGINS__) return;
  ...
  function api(path, options) {
    ...
    // BOTH dashboard modes: loopback (X-Clawksis-Session-Token header) and

    // gated OAuth (clawk_session_at cookie via credentials:'include').

    // Hand-rolling fetch + reading window.__CLAWK_SESSION_TOKEN__ directly
    ...
    const url = "/api/plugins/clawk-achievements" + path;
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function download() {
      ...
      a.download = "clawk-achievement-" + (achievement.id || "badge") + ".png";
    ...
    function tweetText() {
      ...
      const tmpl = tx(t, "share.tweet_text", "Just unlocked {tier_part}\"{name}\" in Clawksis ☤", {
      ...
      return tmpl + "\n\n@NousResearch · https://github.com/samuelgradientai-sys/clawksis-agent";
    ...
    return React.createElement("div", { className: "ha-page ha-page-loading" },
      ...
      React.createElement("section", { className: "ha-hero ha-loading-hero" },
        ...
        React.createElement("div", null,
          ...
          React.createElement("h1", null, tx(t, "hero.title", "Clawksis Achievements")),

          React.createElement("p", null, tx(t, "hero.scan_subtitle", "Scanning Clawksis session history. First scan can take 5–10 seconds on large histories."))
      ...
      React.createElement("section", { className: "ha-guide ha-loading-guide" },
        ...
        React.createElement("div", null,
          ...
          React.createElement("p", null, tx(t, "guide.scan_status_body", "Clawksis is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds."))
    ...
    return React.createElement("div", { className: "ha-page" },
      ...
      React.createElement("section", { className: "ha-hero" },
        ...
        React.createElement("div", null,
          ...
          React.createElement("p", null, tx(t, "hero.subtitle", "Collectible Clawksis badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears."))
      ...
      React.createElement("div", { className: "ha-stats" },
        ...
        React.createElement(StatCard, { label: tx(t, "stats.latest", "Latest"), value: latest[0] ? latest[0].name : tx(t, "stats.none_yet", "None yet"), hint: latest[0] ? latest[0].category : tx(t, "stats.latest_hint_empty", "run Clawksis more") })
      ...
      React.createElement("section", { className: "ha-guide" },
        ...
        React.createElement("div", null,
          ...
          React.createElement("p", null, tx(t, "guide.secret_body", "Secrets hide their exact trigger. Once Clawksis sees a related signal, the card becomes Discovered and shows its requirement."))
  ...
  window.__CLAWK_PLUGINS__.register("clawk-achievements", AchievementsPage);
