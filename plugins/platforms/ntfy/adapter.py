"""ntfy platform adapter (Clawksis plugin).
...
a Clawksis dependency.

This adapter ships as a Clawksis platform plugin under
``plugins/platforms/ntfy/``. The Clawksis plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "clawk-in"              # subscribe topic (incoming)
          publish_topic: "clawk-out"     # optional — defaults to topic
...
_ECHO_TAG = "clawksis-agent"  # tag added to outgoing messages for echo-loop prevention
...
async def _standalone_send(
    ...
    *,
    ...
    ``clawk cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Clawksis dependency",
