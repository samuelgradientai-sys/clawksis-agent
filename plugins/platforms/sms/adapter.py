...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Clawksis gateway adapter.

    Each inbound phone number gets its own Clawksis session (multi-tenant).
...
# static dict in clawk_cli/gateway.py, and the _send_sms dispatch in
