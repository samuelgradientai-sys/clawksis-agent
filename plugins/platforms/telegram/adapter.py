...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._media_batch_delay_seconds = env_float("CLAWK_TELEGRAM_MEDIA_BATCH_DELAY_SECONDS", 0.8)
    ...
    async def _run_post_connect_housekeeping(self) -> None:
        ...
        try:
            ...
            try:
                ...
                from clawk_cli.commands import telegram_menu_commands, telegram_menu_max_commands
                if not self._bot:
                    return
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            request_kwargs = {
                ...
                "connect_timeout": _env_float("CLAWK_TELEGRAM_HTTP_CONNECT_TIMEOUT", 10.0),
            ...
            disable_fallback = (os.getenv("CLAWK_TELEGRAM_DISABLE_FALLBACK_IPS", "").strip().lower() in {"1", "true", "yes", "on"})
