...
Configuration
-------------
Secret (lives in $CLAWK_HOME/.env or the environment):
...
Behavioral settings (live in $CLAWK_HOME/mem0.json, set via `clawk memory
setup`):
  ...
  agent_id           — Agent identifier (default: clawk)
...
def _load_config() -> dict:
    """Load config from env vars, with $CLAWK_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "clawk"),
        "oss": {},
    }
    ...
    config_path = get_clawk_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, clawk_home):
        """Write config to $CLAWK_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $CLAWK_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "clawk")
