...
Config via environment variables (profile-scoped via each profile's .env):
  ...
  OPENVIKING_AGENT   — Tenant agent (default: clawk)
...
class _VikingClient:
    ...
    def __init__(
        ...
        self._agent = agent or os.environ.get("OPENVIKING_AGENT", "clawk")
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        ...
        return [
            ...
            {
                "key": "agent",
                "description": "OpenViking agent ID within the account ([clawk], useful in multi-agent mode)",
                "default": "clawk",
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent = os.environ.get("OPENVIKING_AGENT", "clawk")
