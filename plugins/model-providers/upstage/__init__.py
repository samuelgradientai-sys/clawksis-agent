...
# When the user hasn't picked a reasoning effort, Clawksis passes
...
# ON at this effort — matching the "medium (default)" that Clawksis' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Clawksis' effort vocabulary onto Solar's accepted set. xhigh/max/
