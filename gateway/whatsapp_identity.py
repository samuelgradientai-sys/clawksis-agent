...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$CLAWK_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_clawk_dir("platforms/whatsapp/session", "whatsapp/session")
