...
def _get_clawk_version() -> str:
    """Return the clawksis-agent package version, or 'dev' if unavailable."""
...
def build_user_agent() -> str:
    ...
    Format::
        ...
        QQBotAdapter/<qqbot_version> (Python/<py_version>; <os>; Clawksis/<clawk_version>)
    ...
    Example::
        ...
        QQBotAdapter/1.0.0 (Python/3.11.15; darwin; Clawksis/0.9.0)
    ...
    clawk_version = _get_clawk_version()

    return f"QQBotAdapter/{QQBOT_VERSION} (Python/{py_version}; {os_name}; Clawksis/{clawk_version})"
