...
Config: ~/.clawksis/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.clawksis/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_clawk_home()`` helper (CLAWK_HOME-aware and
...
RULES_FILE = get_clawk_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_clawk_home() / "feishu_comment_pairing.json"
