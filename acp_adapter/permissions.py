"""ACP permission bridging for Clawksis dangerous-command approvals."""
...
# Maps ACP permission option ids to Clawksis approval result strings.
...
def _map_outcome_to_clawk(outcome: object, *, allowed_option_ids: set[str]) -> str:
    """Map an ACP permission outcome into Clawksis approval strings."""
    ...
    if option_id not in allowed_option_ids:
        ...
        return "deny"
    return _OPTION_ID_TO_CLAWKSIS.get(option_id, "deny")
...
def make_approval_callback(
    ...
    """
    Return a Clawksis-compatible approval callback that bridges to ACP.
