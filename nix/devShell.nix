...

{
  ...
  perSystem =
    ...
    let
      ...
      clawkNpmLib = self'.packages.default.passthru.clawkNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. clawksis-agent
...

    {
      ...
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          ...
          echo "Clawksis dev shell"

          ${combinedNonNpm}

          ${clawkNpmLib.mkNpmDevShellHook npmPackageJsonPaths fixLockfilesExe}

          echo "Ready. Run 'clawk' to start."
