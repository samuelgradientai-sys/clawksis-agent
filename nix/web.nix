# nix/web.nix — Clawksis Web Dashboard (Vite/React) frontend build
{ pkgs, clawkNpmLib, ... }:
let
  npm = clawkNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "clawksis-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../clawk_cli/web_dist for the
