...
# Guía extendida de comandos (integrada desde Andresito)

> Documentación detallada de instalación, comandos, dashboard, mensajería y cron — preservada desde el README extendido de la rama **Andresito** (Andres Pinilla). El README.md principal conserva el branding; esta sección guarda la guía completa.
