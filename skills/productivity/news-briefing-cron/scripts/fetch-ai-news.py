...
data = fetch(
    f"https://hn.algolia.com/api/v1/search?query=AI+artificial+intelligence&tags=story&hitsPerPage=10&numericFilters=created_at_i>{int(datetime.now().timestamp()) - 172800}"
)
if data:
    try:
