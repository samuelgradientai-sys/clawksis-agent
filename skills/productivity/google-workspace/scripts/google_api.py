...
"""Google Workspace API CLI for Clawksis.



Uses the Google Workspace CLI (`gws`) when available, but preserves the

existing Clawksis-facing JSON contract and falls back to the Python client
...
from _clawk_home import get_clawk_home
...
def _gws_binary() -> str | None:
    ...
    override = os.getenv("CLAWK_GWS_BIN")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Google Workspace API for Clawksis")
