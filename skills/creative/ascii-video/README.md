...
Built for [Clawksis](https://github.com/samuelgradientai-sys/clawksis-agent). Usable in any coding agent. Canonical source lives here; synced to [`samuelgradientai-sys/clawksis-agent/skills/creative/ascii-video`](https://github.com/samuelgradientai-sys/clawksis-agent/tree/main/skills/creative/ascii-video) via PR.
