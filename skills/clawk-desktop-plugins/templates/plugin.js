/**
 * Clawksis desktop plugin template. Save as:
 *   <clawk home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <clawk home> is ~/.clawksis by default, or ~/.clawksis/profiles/<name>
 * when running a named profile (`clawk -p <name>`). Run `clawk doctor` (or
 ...
 * Only these imports resolve: @clawk/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@clawk/plugin-sdk'
