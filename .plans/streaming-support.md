# Streaming LLM Response Support for Clawksis
...
```
CLAWK_STREAMING_ENABLED=true    # Master switch via env
```
...
| `clawk_cli/config.py` | 1 | +streaming config defaults |
