...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef(
        "snapshot",
        "Create or restore state snapshots of Clawksis config/state",
        "Session",
        cli_only=True,
        aliases=("snap",),
    ...
    CommandDef(
        "busy",
        "Control what Enter does while Clawksis is working",
        "Configuration",
        cli_only=True,
    ...
    CommandDef(
        "reload-skills",
        "Re-scan ~/.clawksis/skills/ for newly installed or removed skills",
        "Tools & Skills",
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append((
        "clawk",
        "Talk to Clawksis or run a subcommand",
        "[subcommand] [args]",
    ))
...
def slack_app_manifest(
    request_url: str = "https://clawksis-agent.local/slack/commands",
) -> dict[str, Any]:
...
# LM Studio serves the list of currently-loaded models over HTTP; probing it on

# every keystroke would block the UI, so a short TTL keeps it live without
