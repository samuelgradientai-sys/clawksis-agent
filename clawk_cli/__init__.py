"""
Clawksis CLI - Unified command-line interface for Clawksis.

Provides subcommands for:
- clawk chat          - Interactive chat (same as ./clawk)
- clawk gateway       - Run gateway in foreground
- clawk gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `clawk setup` on a fresh Pi.
    ...
    clawk_cli/stdio.py::configure_windows_stdio() runs later from the entry
