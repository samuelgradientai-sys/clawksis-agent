...
Skills configuration for Clawksis.

`clawk skills` enters this module.



Toggle individual skills or categories on/off, globally or per-platform.

Config stored in ~/.clawksis/config.yaml under:
...
from clawk_cli.platforms import PLATFORMS as _PLATFORMS
