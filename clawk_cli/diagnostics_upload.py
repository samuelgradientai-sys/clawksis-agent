"""Client for uploading ``clawk debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``clawk debug share``.
...
NAS_BASE = os.environ.get(
    "CLAWK_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "clawksis-agent/debug-share"
