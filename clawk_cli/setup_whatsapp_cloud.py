...
Entry point: ``clawk whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``clawk_cli/main.py``).
...
Clawksis gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Clawksis to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Clawksis needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Clawksis gateway in another terminal:")
    print("         clawk gateway")
    print()
    ...
    print()
    print("  Docs: https://clawksis-agent.nousresearch.com/docs/user-guide/")
