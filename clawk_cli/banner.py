...
def check_for_updates() -> Optional[int]:
    ...
    # CLAWK_REVISION (that's nix-only). Without this guard the checks below
    ...
    # and `clawk update` correctly refuses to run in-place inside the

    # container anyway. The dashboard's REST `/api/clawk/update/check`
...
_RELEASE_URL_BASE = (
    "https://github.com/samuelgradientai-sys/clawksis-agent/releases/tag"
)
...
def print_clawksis_banner():
    """Imprime el banner CLAWKSIS estilo ANSI Shadow en morado. UTF-8 forzado."""
    import sys
