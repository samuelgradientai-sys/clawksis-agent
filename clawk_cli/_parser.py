...
Examples:
    ...
    clawk console                Open the safe Clawksis command console
...
def build_top_level_parser():
    ...
    _inherited_flag(
        ...
        help=(
            ...
            "without a TTY prompt.  Equivalent to CLAWK_ACCEPT_HOOKS=1 or "
    ...
    # top-level parser: when the user writes `clawk -m foo chat`, argparse
    ...
    # `-w/--worktree`, `--yolo`, etc. (see tests/clawk_cli/
    ...
    _inherited_flag(
        ...
        help=(
            "Auto-approve any unseen shell hooks declared in config.yaml "
            "without a TTY prompt (see also CLAWK_ACCEPT_HOOKS env var and "
