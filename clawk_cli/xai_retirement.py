...
Pure logic: walks a Clawksis config dict, returns issues for any reference
...
def find_retired_xai_refs(config: Dict[str, Any]) -> List[RetirementIssue]:
    """Walk all model slots in a Clawksis config and return retirement issues.
...
def apply_migration(
    ...
    from clawk_cli.config import require_readable_config_before_write
