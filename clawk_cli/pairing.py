...
Usage:
    ...
    clawk pairing list              # Show all pending + approved users

    clawk pairing approve <platform> <code>  # Approve a pairing code

    clawk pairing revoke <platform> <user_id> # Revoke user access

    clawk pairing clear-pending     # Clear all expired/pending codes

"""


def pairing_command(args):
    """Handle clawk pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: clawk pairing {list|approve|revoke|clear-pending}")

        print("Run 'clawk pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.clawksis/platforms/pairing/_rate_limits.json\n".format(platform)
        )

    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")

        print("  Run 'clawk pairing list' to see pending codes.\n")
