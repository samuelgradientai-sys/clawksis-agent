"""Clawksis middleware contract helpers.
...
MIDDLEWARE_SCHEMA_VERSION = "clawk.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before Clawksis sends them.
    """
...
def _invoke_middleware(kind: str, **kwargs: Any) -> List[Any]:
    from clawk_cli.plugins import invoke_middleware

    return invoke_middleware(kind, **middleware_payload(**kwargs))


def _has_middleware(kind: str) -> bool:
    from clawk_cli.plugins import has_middleware
