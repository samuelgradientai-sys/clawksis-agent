...
DEFAULT_CODEX_MODELS: List[str] = [
    ...
    # in clawk_cli/models.py — only the openai-codex (OAuth) provider
    ...
    # Clawksis uses. Removed here. If OpenAI re-enables them on Codex backend,
