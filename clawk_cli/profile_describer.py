...
Used by ``clawk profile describe <name> --auto`` and the dashboard's
...
- Mirrors the shape of ``clawk_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Clawksis kanban board.
...
Rules:
  ...
  - Never write "Clawksis profile" or other meta-narration.
