"""``clawk mcp`` subcommand parser.

Extracted from ``clawk_cli/main.py:main()`` (god-file Phase 2 follow-up).
...
from clawk_cli.subcommands._shared import add_accept_hooks_flag
