...
CATALOG: List[Dict[str, Any]] = [
    ...
    _m(
        "Phi-3.5 Mini 3.8B", "Phi", 3.8, "phi3.5:3.8b", 131072, False, "Small reasoning"
    ),
    _m(
        "Phi-4 Mini 3.8B",
        "Phi",
    ...
    _m(
        "Moondream 1.8B", "Moondream", 1.8, "moondream:1.8b", 2048, False, "Tiny vision"
    ),
