...
TIPS = [
    ...
    "Profiles scope Clawksis state via CLAWK_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    "CLAWK_WRITE_SAFE_ROOT restricts write_file/patch to directory prefixes; multiple paths via os.pathsep (: or ;).",
    ...
    "clawk import restores a full Clawksis backup zip; session JSON/JSONL exports import from the dashboard Sessions page.",
