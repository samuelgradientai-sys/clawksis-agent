...
def _apply_external_secret_sources(home_path: Path) -> None:
    ...
    locate the access token) but BEFORE the rest of Clawksis reads
    ...
    (tests, future ``clawk secrets bitwarden sync`` from a long-running
    ...
    if result.applied:
        ...
        # Remember where these came from so the setup / `clawk model`
