"""CLI subcommand: `clawk curator <subcommand>`.
...
def _cmd_run(args) -> int:
    ...
    if not synchronous:
        ...
        print("llm pass running in background — check `clawk curator status` later")
    ...
    if dry:
        ...
        if synchronous:
            ...
            print(
                ...
                "`clawk curator status` and run `clawk curator run` (no flag) to apply."
...
def _cmd_archive(args) -> int:
    ...
    if skill_usage.get_record(args.skill).get("pinned"):
        ...
        print(
            ...
            f"`clawk curator unpin {args.skill}`"
...
def _cmd_backup(args) -> int:
    ...
    print(f"curator: snapshot created at ~/.clawksis/skills/.curator_backups/{snap.name}")
...
def _cmd_rollback(args) -> int:
    ...
    if target_path is None:
        ...
        if not rows:
            ...
            print(
                ...
                "`clawk curator backup` or wait for the next curator run."
    ...
    print(
        ...
        "\nThis will replace the current ~/.clawksis/skills/ tree (a safety "
...
def register_cli(parent: argparse.ArgumentParser) -> None:
    ...
    p_backup = subs.add_parser(
        ...
        help="Take a manual tar.gz snapshot of ~/.clawksis/skills/ "
    ...
    p_rollback = subs.add_parser(
        ...
        help="Restore ~/.clawksis/skills/ from a curator snapshot "
...
def cli_main(argv=None) -> int:
    ...
    """Standalone entry (also usable by clawk_cli.main fallthrough)."""
