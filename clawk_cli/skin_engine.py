"""Clawksis CLI skin/theme engine.



A data-driven skin system that lets users customize the CLI's visual appearance.

Skins are defined as YAML files in ~/.clawksis/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      ...
      agent_name: "Clawksis"          # Banner title, status display

      welcome: "Welcome message"          # Shown at CLI startup

      goodbye: "Goodbye! ∇"              # Shown on exit

      response_label: " ∇ Clawksis "       # Response box header label
...
.. code-block:: python
    ...
    from clawk_cli.skin_engine import get_active_skin, list_skins, set_active_skin
    ...
    print(skin.get_branding("agent_name"))  # "Clawksis"



    set_active_skin("ares")               # Switch to built-in ares skin

    set_active_skin("mytheme")            # Switch to user skin from ~/.clawksis/skins/
...
Drop a YAML file in ``~/.clawksis/skins/<name>.yaml`` following the schema above.
