 ...
 * Symptom: in `clawk --tui`, typing into the composer until the input
...
import { wrapAnsi } from '@clawk/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using clawk --tui and as i type multiline my caret at the end will often ' +
