...
import type { ScrollBoxHandle } from '@clawk/ink'
import { evictInkCaches } from '@clawk/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.CLAWK_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
