import { Box, type ScrollBoxHandle, stringWidth, Text } from '@clawk/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (CLAWK_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (CLAWK_DEV_CREDITS), lowest priority,
