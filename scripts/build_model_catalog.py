#!/usr/bin/env python3
"""Build the Clawksis Model Catalog — a centralized JSON manifest of curated models.
...
Clawksis CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Clawksis release.
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            ...
            "docs": "https://clawksis-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
