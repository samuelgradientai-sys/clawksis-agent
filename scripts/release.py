...
VERSION_FILE = REPO_ROOT / "clawk_cli" / "__init__.py"
...
LEGACY_AUTHOR_MAP = {
    ...
    "pi@clawk.local": "Elektrofussel",  # PR #61675 salvage (honcho: defaultHost + private-range local URL detection)
    ...
    "kavi@local.clawk": "kavioavio",  # Issue #46544 / PR #47705 evolution (smart DENY exact-operation owner override)
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level CLAWK_HOME for pid/lock/status identity files; #56986)
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (clawk journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "clawk.wanderer@yahoo.com": "trismegistus-wanderer",  # PR #31856 salvage (gateway: defer idle-TTL agent-cache eviction until the session store says the session actually expired, so the expiry watcher can still fire MemoryProvider.on_session_end with the live transcript; #11205)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.clawksis/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "121278003+Cossackx@users.noreply.github.com": "Cossackx",  # PR #52528 salvage (Windows clawk-shim resolution + prefer --update on recovery; #52378)
    ...
    "274096618+clawksis-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "clawk@nousresearch.com": "NousResearch",
    ...
    "sberan@gmail.com": "sberan",  # PR #54494 salvage (--connect-timeout flag on clawk mcp add)
    ...
    "clawk@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (CLAWK_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (CLAWK_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: clawk-eval community link)
    ...
    "clawkagent26@gmail.com": "clawkagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+clawkagent26@users.noreply.github.com": "clawkagent26",
    ...
    "vigo@clawk": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Clawksis runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level CLAWK_HOME state files)
    ...
    "zhchl@clawksis-agent.local": "8294",  # PR #50572 salvage (honor config context_length on banner)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Clawksis
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"clawksis-agent[acp]=={semver}"
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/samuelgradientai-sys/clawksis-agent",
    ...
    lines.append(f"# Clawksis v{semver} ({tag_name})")
    lines.append("")
...
def main():
    ...
    print(f"{'='*60}")
    print("  Clawksis Release Preview")
    print(f"{'='*60}")
