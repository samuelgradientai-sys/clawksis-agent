...
DEFAULT_DATASETS = [
    ...
    "samuelgradientai-sys/clawksis-agent-megascience-sft1",
    "NousResearch/Clawksis-Thinking-GLM-4.7-SFT2",
    "NousResearch/Clawksis-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-clawksis-agent"
]
