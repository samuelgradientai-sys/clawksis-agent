...
const IMAGE_CACHE_DIR = path.join(process.env.HOME || '~', '.clawk', 'image_cache');
const DOCUMENT_CACHE_DIR = path.join(process.env.HOME || '~', '.clawk', 'document_cache');
const AUDIO_CACHE_DIR = path.join(process.env.HOME || '~', '.clawk', 'audio_cache');
