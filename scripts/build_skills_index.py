...
"""Build the Clawksis Skills Index — a centralized JSON catalog of all skills.
...
`clawk skills search/install` can use it without hitting the GitHub API.
...
def main():
    ...
    print("Building Clawksis Skills Index...", flush=True)
