...
def _build_compact_banner() -> str:
    ...
    if skin_name == "default":
        ...
        agent_name = (
            _skin.get_branding("agent_name", "Clawksis") if _skin else "Clawksis"
        )
...
class ClawksisCLI(CLICommandsMixin):
    ...
    def __init__(
        ...
        # Read max_tokens from config (env var override: CLAWK_MAX_TOKENS)
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        if _remainder:
            ...
            _cprint(
                f'  {_DIM}Tip: type your next message, or run clawk chat -q --image {_termux_example_image_path(image_path.name)} "What do you see?"{_RST}'
            )
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if not session_meta:
            ...
            _cprint(
                "  Use /history or `clawk sessions list` to see available sessions."
            )
    ...
    def save_conversation(self):
        ...
        try:
            ...
            if self.session_id:
                print(
                    f"       Resume the live session with: clawk --resume {self.session_id}"
                )
        ...
        if canonical in {"quit", "exit"}:
            ...
            try:
                ...
                if not plugins:
                    ...
                    print(
                        f"Drop plugin directories into {display_clawk_home()}/plugins/ to get started."
                    )
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from clawk_cli.skin_engine import (
                list_skins,
                set_active_skin,
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print(
                f"  Custom skins: drop a YAML file in {display_clawk_home()}/skins/\n"
            )
    ...
    def _handle_busy_command(self, cmd: str):
        ...
        if save_config_value("display.busy_input_mode", arg):
            if arg == "queue":
                ...
                behavior = (
                    "Enter will interrupt the current run while Clawksis is busy."
                )
    ...
    def _voice_speak_response(self, text: str):
        ...
        try:
            ...
            os.makedirs(
                os.path.join(tempfile.gettempdir(), "clawk_voice"), exist_ok=True
            )
    ...
    def run(self):
        ...
        def _get_clarify_display():
            ...
            lines.append((
                ...
                " "
                + ("─" * max(0, box_width - len("Clawksis needs your input") - 3))
                + "╮\n",
            ))
