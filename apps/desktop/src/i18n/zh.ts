...
export const zh: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteTitle: '远程网关',
      remoteDesc:
        '将此桌面外壳连接到远程 Clawksis 后端。托管网关使用 OAuth 或用户名密码；自托管网关也可能使用会话 token。',
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: 'Clawksis Desktop 将使用已保存设置重新连接。',
    ...
    providers: {
      ...
      removeExternal: (provider, command) => `${provider} 由 Clawksis 外部管理。请使用 ${command} 移除。`,
  ...
  updates: {
    ...
    applyingBody: 'Clawksis 更新器会在自己的窗口中接管，并在完成后重新打开 Clawksis。',
    applyingBodyBackend: '远程后端正在应用更新并将重启。恢复后 Clawksis 会自动重新连接。',
    applyingClose: 'Clawksis 将关闭以应用更新。',
    errorTitle: '更新未完成',
  ...
  onboarding: {
    ...
    flowSubtitles: {
      ...
      loopback: '打开浏览器登录 — Clawksis 会自动连接',
