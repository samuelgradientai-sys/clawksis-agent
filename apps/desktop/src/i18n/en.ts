...
export const en: Translations = {
  ...
  boot: {
    ready: 'Clawksis Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Clawksis settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingClawksisDesktop: 'Starting Clawksis Desktop…'
    },
    errors: {
      backgroundExited: 'Clawksis background process exited.',
      backgroundExitedDuringStartup: 'Clawksis background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Clawksis backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    native: {
      ...
      inputBody: 'Clawksis is waiting for your response.',
      turnDoneTitle: 'Clawksis finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Clawksis defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Clawksis writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Clawksis is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Clawksis asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Clawksis was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Clawksis follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Clawksis is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Clawksis, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Clawksis checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Clawksis configuration...',
    ...
    gateway: {
      ...
      intro:
        'Clawksis Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Clawksis backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset CLAWK_DESKTOP_REMOTE_URL and CLAWK_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Clawksis backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Clawksis backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Clawksis Cloud',
      cloudDesc: 'Sign in once to Clawksis Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Clawksis Cloud',
      cloudSignIn: 'Sign in to Clawksis Cloud',
      cloudSignedIn: 'Signed in to Clawksis Cloud',
      cloudNeedsSignIn: 'Sign in to Clawksis Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Clawksis Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Clawksis Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Clawksis Cloud',
      cloudSignedOutMessage: 'Cleared the Clawksis Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /clawk.',
      ...
      restartingMessage: 'Clawksis Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Clawksis ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Clawksis runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Clawksis at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via clawk curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Clawksis builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Clawksis to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Clawksis to generate pets.',
      backgroundHint: 'You can close this — Clawksis will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Clawksis desktop' },
    ...
    clawkActiveSessions: (version, count) => `Clawksis ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@clawk:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Clawksis environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Clawksis backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Clawksis. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Clawksis...',
    placeholderReconnecting: 'Reconnecting to Clawksis…',
    ...
    attachUrlDesc: 'Clawksis will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Clawksis to open PR',
      agentShipPrompt:
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Clawksis can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Clawksis from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Clawksis will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Clawksis desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Clawksis updater takes over in its own window and reopens Clawksis automatically when it’s done. Please don’t reopen Clawksis yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Clawksis reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Clawksis reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Clawksis needs a one-time install',
    ...
    settingUpTitle: 'Setting up Clawksis',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Clawksis",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Clawksis is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Clawksis…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Clawksis',
    ...
    authorizeThere: 'Authorize Clawksis there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Clawksis there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Clawksis inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Clawksis will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Clawksis is restarting...',
      askRestart: 'Ask Clawksis to restart the server',
      lookingRestart: taskId => `Clawksis is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Clawksis is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Clawksis finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Clawksis could not restart the server.',
      stillWorking:
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Clawksis is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Clawksis gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.clawksis/config.yaml). Clawksis won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Clawksis needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Clawksis needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Clawksis Desktop to use Save Image.',
    restartToSaveImages: 'Restart Clawksis Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `clawk gateway` running?'
    }
  },
