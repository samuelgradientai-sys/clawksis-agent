...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteDesc:
        'Connect this desktop shell to a remote Clawksis backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Clawksis Desktop will reconnect using the saved settings.',
    ...
    providers: {
      ...
      removeExternal: (provider, command) => `${provider} is managed outside Clawksis. Remove it with ${command}.`,
  ...
  updates: {
    ...
    applyingBody: 'The Clawksis updater will take over in its own window and reopen Clawksis when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Clawksis reconnects automatically when it’s back.',
    applyingClose: 'Clawksis will close to apply the update.',
