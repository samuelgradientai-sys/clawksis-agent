...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    providers: {
      ...
      removeExternal: (provider, command) => `${provider} 由 Clawksis 外部管理。請使用 ${command} 移除。`,
  ...
  updates: {
    ...
    applyingBody: 'Clawksis 更新程式會在自己的視窗中接管，並在完成後重新開啟 Clawksis。',
    applyingBodyBackend: '遠端後端正在套用更新並將重新啟動。恢復後 Clawksis 會自動重新連線。',
    applyingClose: 'Clawksis 將關閉以套用更新。',
    errorTitle: '更新未完成',
  ...
  onboarding: {
    ...
    flowSubtitles: {
      ...
      loopback: '開啟瀏覽器登入 — Clawksis 會自動連線',
