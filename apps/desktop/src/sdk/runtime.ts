 ...
 * plugins resolve `@clawk/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __CLAWK_PLUGIN_SDK__: sdk,
  __CLAWK_REACT__: React,
  __CLAWK_REACT_JSX__: jsxRuntime,
  __CLAWK_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@clawk/plugin-sdk': shimUrl('__CLAWK_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__CLAWK_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__CLAWK_REACT_JSX__'),
    react: shimUrl('__CLAWK_REACT__')
  }
