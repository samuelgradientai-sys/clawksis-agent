...
import type { ClawksisGitWorktree, ClawksisRepoStatus } from '@/global'
...
export const $repoStatus = atom<ClawksisRepoStatus | null>(null)
...
export const $repoWorktrees = atom<ClawksisGitWorktree[]>([])
...
interface RepoStatusRefreshRequest {
  probe: (cwd: string) => Promise<ClawksisRepoStatus | null>
  seq: number
  target: string
}
