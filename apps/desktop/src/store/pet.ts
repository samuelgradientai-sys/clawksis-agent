...
export interface PetInfo {
  ...
  // the Clawksis "run" activity state uses the in-place running row).
 ...
 * CLAWK_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'clawk.desktop.pet-roam.v1'
