...
import { getGlobalModelOptions } from '@/clawk'
...
import type { OAuthProvider } from '@/types/clawk'
...
const API_KEY_OPTIONS: ApiKeyOption[] = [
...

  {
    ...
    description: 'Point Clawksis at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).',

    docsUrl: 'https://github.com/samuelgradientai-sys/clawksis-agent#bring-your-own-endpoint',
...
const FLOW_SUBTITLES: Record<OAuthProvider['flow'], string> = {
  ...
  device_code: 'Opens a verification page in your browser — Clawksis connects automatically',

  loopback: 'Opens your browser to sign in — Clawksis connects automatically',
    ...
    <div className="grid gap-3" role="status">
      ...
      <p className="text-sm text-muted-foreground">
        ...
        {installing
          ...
          ? 'Clawksis is finishing install. This usually takes under a minute on first run.'
    ...
    <div className="border-b border-(--ui-stroke-tertiary) bg-(--ui-chat-bubble-background) px-5 py-4">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <h2 className="text-[0.9375rem] font-semibold tracking-tight">Let's get you setup with Clawksis</h2>
...
const FEATURED_PITCH = 'One subscription, 300+ frontier models — the recommended way to run Clawksis'

const SHOW_ALL_KEY = 'clawk-onboarding-show-all-v1'
    ...
    return (
      ...
      <Step title={`Sign in with ${title}`}>
        ...
        <ol className="list-decimal space-y-1 pl-5 text-sm text-muted-foreground">
          ...
          <li>Authorize Clawksis there.</li>
    ...
    return (
      ...
      <Step title={`Sign in with ${title}`}>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          We opened {title} in your browser. Authorize Clawksis there and you'll be connected automatically — nothing to
