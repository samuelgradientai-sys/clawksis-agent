...
const STORAGE_KEY = 'clawk.desktop.layoutTree.v2'

writeKey('clawk.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('clawk.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('clawk.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'clawk.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'clawk.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__CLAWK_LAYOUT_TREE__ = {
    close: closeTreePane,
