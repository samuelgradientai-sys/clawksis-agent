...
import { extractDroppedFiles, CLAWK_PATHS_MIME } from '@/app/chat/hooks/use-composer-actions'
import { ClarifyTool } from '@/components/assistant-ui/clarify-tool'
import { DirectiveContent, clawkDirectiveFormatter } from '@/components/assistant-ui/directive-text'
...
const ResponseLoadingIndicator: FC = () => {
  ...
  return (
    <StatusRow data-slot="aui_response-loading" label="Clawksis is loading a response">
