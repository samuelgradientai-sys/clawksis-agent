...
const SCRIPT: Record<string, { id: string; src: string }> = {
  instagram: { id: 'clawk-ig-embed', src: 'https://www.instagram.com/embed.js' },
  tiktok: { id: 'clawk-tt-embed', src: 'https://www.tiktok.com/embed.js' },
  twitter: { id: 'clawk-tw-embed', src: 'https://platform.twitter.com/widgets.js' }
}
