...
export const ClarifyTool = (props: ToolCallMessagePartProps) => {
  ...
  // Once Clawksis records an answer, fall back to the standard tool block so
  ...
  const respond = useCallback(
    ...
    async (answer: string) => {
      ...
      if (!gateway) {
        ...
        notifyError(new Error('Clawksis gateway is not connected'), 'Could not send clarify response')
