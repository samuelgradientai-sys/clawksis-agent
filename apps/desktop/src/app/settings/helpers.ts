...
import type { ConfigFieldSchema, ClawksisConfigRecord, ToolsetInfo } from '@/types/clawk'
...
export function getNested(obj: ClawksisConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ClawksisConfigRecord, path: string, value: unknown): ClawksisConfigRecord {
...
function personalityOptions(config: ClawksisConfigRecord): string[] {
...
function commandProviderNames(config: ClawksisConfigRecord, section: 'tts' | 'stt'): string[] {
