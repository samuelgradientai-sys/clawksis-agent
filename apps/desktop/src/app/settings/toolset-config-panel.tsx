...
import { deleteEnvVar, getToolsetConfig, revealEnvVar, selectToolsetProvider, setEnvVar } from '@/clawk'
...
import type { ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/clawk'
              ...
              <div className="grid gap-2 bg-muted/20 p-3">
                ...
                {provider.post_setup && (
                  ...
                  <p className="text-[0.72rem] text-muted-foreground">
                    ...
                    <code className="font-mono">clawk tools</code> for now.
