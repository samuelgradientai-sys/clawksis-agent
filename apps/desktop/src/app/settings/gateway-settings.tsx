...
// Clawksis Cloud discovery lifecycle for the cloud-mode panel.
...
export function GatewaySettings({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  // --- Clawksis Cloud (cloud mode) state ---
  ...
  return (
    <SettingsContent bare={embedded}>
      ...
      {/* Clawksis Cloud panel: one portal sign-in, then a discovered-agent picker
