...
export const FIELD_DESCRIPTIONS: Record<string, string> = {
  ...
  file_read_max_chars: 'Maximum characters Clawksis can read from one file request.',
  'approvals.mode': 'How Clawksis handles commands that need explicit approval.',
  ...
  'agent.max_turns': 'Upper bound for tool-calling turns before Clawksis stops a run.',
