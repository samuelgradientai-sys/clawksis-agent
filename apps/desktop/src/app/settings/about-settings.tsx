...
const RELEASE_NOTES_URL = 'https://github.com/samuelgradientai-sys/clawksis-agent/releases'
    ...
    <SettingsContent>
      ...
      <div className="flex flex-col items-center gap-3 pt-6 pb-2 text-center">
        ...
        <div>
          ...
          <h2 className="text-lg font-semibold tracking-tight">Clawksis Desktop</h2>
      ...
      <div className="mx-auto mt-4 w-full max-w-2xl">
            ...
            <Button asChild className="ml-auto" size="sm" variant="text">
              ...
              <a
                ...
                onClick={event => {
                  ...
                  void window.clawkDesktop?.openExternal?.(RELEASE_NOTES_URL)
        ...
        <ListRow
          ...
          description="Clawksis checks for updates automatically in the background and lets you know when one is ready."
