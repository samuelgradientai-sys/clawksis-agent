...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <clawk home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('clawk:open-keybinds'))
    } satisfies PaletteContribution
  }
])
...
const $logsOpen = persistentAtom('clawk.desktop.logsOpen', false, Codecs.bool)
