...
import { getSessionMessages, triggerCronJob } from '@/clawk'
...
export function ContribWiring({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('clawk:open-keybinds', onOpenKeybinds)

    return () => window.removeEventListener('clawk:open-keybinds', onOpenKeybinds)
  }, [navigate])
  ...
  useEffect(() => {
    ...
    void refreshClawksisConfig(true)
    void refreshActiveProfile()
  }, [activeGatewayProfile, refreshCurrentModel, refreshClawksisConfig])
