...
import type { ModelOptionProvider, ModelOptionsResponse } from '@/types/clawk'
...
export function ModelMenuPanel({ gateway, onSelectModel, requestGateway }: ModelMenuPanelProps) {
  ...
  // session (effort/fast), gated by capability. Unset → Clawksis defaults.
              ...
              <DropdownMenuGroup className="py-0.5" key={slug}>
                ...
                {!collapsed &&
                  group.families.map(family => {
                    ...
                    // the active model, otherwise its remembered preset (Clawksis
