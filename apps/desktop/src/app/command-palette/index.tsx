...
import { getClawksisConfigRecord, listAllProfileSessions } from '@/clawk'
...
// Clawksis session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
export function CommandPalette() {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getClawksisConfigRecord,
    enabled: open
  })
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-clawk',
            keywords: ['update', 'upgrade', 'clawk', 'version', 'system', 'restart'],
            label: cc.updateClawksis,
