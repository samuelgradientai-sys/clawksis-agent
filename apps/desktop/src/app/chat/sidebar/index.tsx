...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/clawk'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('clawk:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('clawk:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Clawksis to
