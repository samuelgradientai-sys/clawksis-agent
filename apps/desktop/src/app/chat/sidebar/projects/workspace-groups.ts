...
import type { ProjectInfo, SessionInfo } from '@/clawk'
 ...
 * repo shows its branches/worktrees even when they have no Clawksis sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: ClawksisGitWorktree[]
): SidebarSessionGroup[] {
