...
import type { SessionInfo } from '@/clawk'
 ...
 * e.g. `clawksis-agent/desktop` vs `clawksis-agent-wt-rtl/desktop`. Groups with a
...
export type WorktreeResolver = (cwd: string) => ClawksisWorktreeInfo | null | undefined
