...
const FOCUS_EVENT = 'clawk:composer-focus'
const INSERT_EVENT = 'clawk:composer-insert'
const INSERT_REFS_EVENT = 'clawk:composer-insert-refs'
const SUBMIT_EVENT = 'clawk:composer-submit'
const VOICE_TOGGLE_EVENT = 'clawk:composer-voice-toggle'
