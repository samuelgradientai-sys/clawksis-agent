...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/clawk'
...
const VERSION = 3
const PREFIX = 'HML' // "Clawksis Memory Loadout" — namespaces our codes like WoW's leading bytes.
