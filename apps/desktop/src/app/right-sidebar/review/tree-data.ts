import type { ClawksisReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ClawksisReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ClawksisReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
