...
const TAKEOVER_KEY = 'clawk.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Clawksis can't clear via the API — the user
 *  sees exactly what runs instead of Clawksis silently deleting their creds. */
