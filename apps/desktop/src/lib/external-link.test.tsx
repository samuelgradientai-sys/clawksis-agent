...
const desktopWindow = window as unknown as { clawkDesktop?: Window['clawkDesktop'] }
const initialClawksisDesktop = desktopWindow.clawkDesktop

function installDesktopBridge(partial: Partial<Window['clawkDesktop']> = {}) {
  desktopWindow.clawkDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['clawkDesktop']
}
...
afterEach(() => {
  ...
  if (initialClawksisDesktop) {
    desktopWindow.clawkDesktop = initialClawksisDesktop
  } else {
    delete desktopWindow.clawkDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['clawkDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['clawkDesktop']['openExternal'] })
