 ...
 * `<clawk home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'clawk.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'clawk.desktop.disabledPlugins.v1'
