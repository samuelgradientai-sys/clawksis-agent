...
// even though a fresh shell — and the Clawksis CLI — sees it immediately. The
// desktop's CLAWK_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\clawk. Reading
...
//       CLAWK_HOME    REG_SZ    F:\Clawksis\data
//
