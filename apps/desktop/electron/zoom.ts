...
export const ZOOM_STORAGE_KEY = 'clawk:desktop:zoomLevel'
 ...
 * but forgot to emit 'clawk:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('clawk:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
