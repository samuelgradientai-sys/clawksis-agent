 ...
 *
 * A public install can end up with `origin=git@github.com:samuelgradientai-sys/clawksis-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/samuelgradientai-sys/clawksis-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/clawksis-agent'
