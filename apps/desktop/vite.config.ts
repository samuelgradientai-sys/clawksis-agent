...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\clawk\clawksis-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@clawk/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@clawk/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@clawk/shared': path.resolve(__dirname, '../shared/src'),
